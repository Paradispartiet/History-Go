...
## Metadata
- Generated at (UTC): 2026-05-15T13:09:45.912Z
- Command: `npm run typecheck`
- Typecheck exit code: 2
- Total diagnostic lines found: 2142
...
2. Focus first on concentrated hotspots: `js/ui/place-card.js` (140), `js/Civication/ui/CivicationUI.js` (107), `js/Civication/core/civicationEventEngine.js` (97), `js/profile.js` (84), `js/ui/popup-utils.js` (82).
