...
Alle 18 aktive Oslo-steder med `politikk` som hovedkategori har dokumenterte People-koblinger. Arbeidet er gjennomført i tre batcher og fordeler personene etter deres faktiske fagrolle.
...
- 16 dokumenterte gjenbrukskoblinger til canonical personer på tvers av batchene
...
- Civication People-indeksen og `dist/web` er regenerert
- to regresjonstester låser 18/18-dekning, fagfiler, ID-er, kilder og minimumstall
