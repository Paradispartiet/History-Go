...
Generated: 2026-07-27T12:24:34.725Z

## Sammendrag
- People-filer lest: **727**
- People lest: **1367**
- People med ugyldige refs: **37**
- Ugyldige refs: **286**
- Unike ugyldige placeId-er: **113**
- People uten gyldig sted: **0**
- Duplikate interne place-referanser: **1407**
...
- **henrik_bull** (Henrik Bull)
  - Freia, Oslo @ `works[6].place`
  - Frogner, Oslo @ `works[5].place`
  - Grünerløkka, Oslo @ `works[1].place`
  - Kirkegata, Oslo @ `works[7].place`
  - Nobels gate, Oslo @ `works[4].place`
  - Regjeringskvartalet, Oslo @ `works[3].place`
  - Studenterlunden, Oslo @ `works[0].place`
...
- **kirsten_sand** (Kirsten Sand)
  - Oslo @ `works[2].place`
  - Oslo @ `works[4].place`
  - Oslo og Aker @ `works[1].place`
  - Skjervøy og Nord-Troms @ `works[5].place`
  - Tromsø @ `works[6].place`
  - Tromsø @ `works[7].place`
  - Trondheim @ `works[0].place`
  - Østkantutstillingen, Oslo @ `works[3].place`
...
- **agnes_mowinckel** (Agnes Mowinckel)
  ...
  - Det Norske Teatret @ `works[5].place`
  - Det Norske Teatret @ `works[6].place`
  - Folketeateret @ `works[7].place`
  - Intimteatret, Kristiania @ `works[2].place`
  - Secondteatret, Kristiania @ `works[1].place`
...
- **bjorn_bjornson** (Bjørn Bjørnson)
  ...
  - Nationaltheatret @ `works[6].place`
  - Nationaltheatret, Oslo @ `works[0].place`
  - Nationaltheatret, Oslo @ `works[1].place`
  - Nationaltheatret, Oslo @ `works[2].place`
  - Skandinaviske og tyskspråklige scener @ `works[3].place`
...
- **egil_eide** (Egil Næss Eide)
  ...
  - Nationaltheatret @ `works[4].place`
  - Nationaltheatret @ `works[5].place`
  - Svensk filmproduksjon @ `works[6].place`
...
- **johanne_dybwad** (Johanne Dybwad)
  ...
  - Nationaltheatret @ `works[5].place`
  - Nationaltheatret @ `works[6].place`
  - Nationaltheatret og Paris @ `works[7].place`
...
- **ragna_wettergreen** (Ragna Wettergreen)
  ...
  - Nationaltheatret @ `works[5].place`
  - Nationaltheatret @ `works[6].place`
  - Nationaltheatret og Den Nationale Scene @ `works[7].place`
...
- **Nationaltheatret** (likely_rename_to_existing_place, 98 treff)
  - nationaltheatret (confidence: high)
- **Oslo** (likely_rename_to_existing_place, 23 treff)
...
- **Det Norske Teatret** (likely_rename_to_existing_place, 14 treff)
...
- **Nationaltheatret, Oslo** (likely_rename_to_existing_place, 5 treff)
...
- **Fagerborg kirke, Stensparken** (likely_rename_to_existing_place, 3 treff)
  ...
  - stensparken (confidence: medium)
- **Oslo Nye Teater** (likely_rename_to_existing_place, 3 treff)
  - oslo_nye_teater_hovedscenen (confidence: medium)
- **Den Nationale Scene** (likely_rename_to_existing_place, 2 treff)
  - den_nationale_scene (confidence: high)
- **Det kongelige slott** (missing_place_candidate, 2 treff)
  - missing_place_candidate
...
- **Sverige** (missing_place_candidate, 2 treff)
  - missing_place_candidate
- **Tromsø** (likely_rename_to_existing_place, 2 treff)
  - kafe_x_tromso (confidence: medium)
  - stromsfoss_sluser (confidence: medium)
- **Trondheim** (likely_rename_to_existing_place, 2 treff)
...
- **Akershus slott** (likely_rename_to_existing_place, 1 treff)
  ...
  - akershus_festning (confidence: low)
  - akershus_kaier (confidence: low)
  - kalmar_slott (confidence: low)
...
- **Bergen Kunstmuseum** (needs_manual_review, 1 treff)
...
- **FN-bygningen, New York** (missing_place_candidate, 1 treff)
  - missing_place_candidate
- **Folketeateret** (likely_rename_to_existing_place, 1 treff)
  - folketeateret (confidence: high)
- **Freia, Oslo** (needs_manual_review, 1 treff)
  - borsen_oslo (confidence: low)
  - brannmuseet_oslo (confidence: low)
  - cinemateket_oslo (confidence: low)
  - fyrlyset_oslo (confidence: low)
  - hallvardskirken_oslo (confidence: low)
- **Frogner, Oslo** (needs_manual_review, 1 treff)
  - borsen_oslo (confidence: low)
  - brannmuseet_oslo (confidence: low)
  - cinemateket_oslo (confidence: low)
...
- **Hansa-salen, Bergen** (missing_place_candidate, 1 treff)
  - missing_place_candidate
...
- **Intimteatret, Kristiania** (missing_place_candidate, 1 treff)
  - missing_place_candidate
- **Kirkegata, Oslo** (needs_manual_review, 1 treff)
  - borsen_oslo (confidence: low)
  - brannmuseet_oslo (confidence: low)
  - centralbanken_kirkegata (confidence: low)
  - cinemateket_oslo (confidence: low)
  - fyrlyset_oslo (confidence: low)
...
- **Nationaltheatret / turné** (likely_rename_to_existing_place, 1 treff)
  - nationaltheatret (confidence: medium)
  - nationaltheatret_stasjon (confidence: low)
- **Nationaltheatret og Den Nationale Scene** (likely_rename_to_existing_place, 1 treff)
  - den_nationale_scene (confidence: medium)
  - nationaltheatret (confidence: medium)
- **Nationaltheatret og Fagerborg skole** (likely_rename_to_existing_place, 1 treff)
  - nationaltheatret (confidence: medium)
- **Nationaltheatret og Paris** (likely_rename_to_existing_place, 1 treff)
  - nationaltheatret (confidence: medium)
...
- **Norge** (likely_rename_to_existing_place, 1 treff)
...
- **Norsk Film A/S** (missing_place_candidate, 1 treff)
  - missing_place_candidate
- **Norsk filmproduksjon** (needs_manual_review, 1 treff)
  - norsk_folkemuseum (confidence: low)
...
- **Oslo og Aker** (missing_place_candidate, 1 treff)
  - missing_place_candidate
...
- **Secondteatret, Kristiania** (missing_place_candidate, 1 treff)
  - missing_place_candidate
- **Skandinaviske og tyskspråklige scener** (missing_place_candidate, 1 treff)
  - missing_place_candidate
- **Skjervøy og Nord-Troms** (missing_place_candidate, 1 treff)
  - missing_place_candidate
...
- **Suldal kommune** (missing_place_candidate, 1 treff)
  - missing_place_candidate
- **Svensk filmproduksjon** (missing_place_candidate, 1 treff)
  - missing_place_candidate
...
- **Våler i Solør** (missing_place_candidate, 1 treff)
  - missing_place_candidate
- **Østkantutstillingen, Oslo** (needs_manual_review, 1 treff)
  - borsen_oslo (confidence: low)
  - brannmuseet_oslo (confidence: low)
  - cinemateket_oslo (confidence: low)
  - fyrlyset_oslo (confidence: low)
...
- data/people/by/oslo/people_by_oslo.json :: kirsten_sand (Kirsten Sand) -> Oslo x2
- data/people/by/oslo/people_by_oslo.json :: kirsten_sand (Kirsten Sand) -> Tromsø x2
...
- data/people/litteratur/oslo/nationaltheatret/bjorn_bjornson.json :: bjorn_bjornson (Bjørn Bjørnson) -> Nationaltheatret, Oslo x3
- data/people/litteratur/oslo/nationaltheatret/bjorn_bjornson.json :: bjorn_bjornson (Bjørn Bjørnson) -> Nationaltheatret x2
...
- data/people/litteratur/oslo/nationaltheatret/halfdan_christensen.json :: halfdan_christensen (Halfdan Christensen) -> Nationaltheatret x7
...
- data/people/litteratur/oslo/nationaltheatret/ragna_wettergreen.json :: ragna_wettergreen (Ragna Wettergreen) -> Nationaltheatret x6
- data/people/litteratur/oslo/nationaltheatret/egil_eide.json :: egil_eide (Egil Næss Eide) -> nationaltheatret x2
- data/people/litteratur/oslo/nationaltheatret/egil_eide.json :: egil_eide (Egil Næss Eide) -> Nationaltheatret x4
...
- data/people/litteratur/oslo/nationaltheatret/agnes_mowinckel.json :: agnes_mowinckel (Agnes Mowinckel) -> Det Norske Teatret x4
