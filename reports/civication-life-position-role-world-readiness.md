...
**Classification:** 140 ready / 19 needs_authored_depth / 40 not_a_standalone_world
**Livelihood-backed:** 15
**Exact governed-source matches:** 140
**Multi-scene narrative foundations:** 140
**Completed life-position Role Worlds:** 140
...
| ---: | --- | --- | ---: | ---: | ---: |
| 1 | `subkultur/observ_r` | needs_authored_depth | 0 | 0 | 0 |
| 2 | `kunst/kunstsamler` | needs_authored_depth | 0 | 0 | 0 |
| 3 | `naeringsliv/sideprosjektbygger` | needs_authored_depth | 0 | 0 | 0 |
| 4 | `filosofi/filosofistudent` | needs_authored_depth | 0 | 0 | 0 |
| 5 | `historie/doktorgradsstudent_historie` | needs_authored_depth | 0 | 0 | 0 |
| 6 | `historie/masterstuden_historie` | needs_authored_depth | 0 | 0 | 0 |
| 7 | `historie/student_historie` | needs_authored_depth | 0 | 0 | 0 |
| 8 | `kunst/kuratorpraksis` | needs_authored_depth | 0 | 0 | 0 |
| 9 | `musikk/artist` | needs_authored_depth | 0 | 0 | 0 |
| 10 | `musikk/frilansmusiker` | needs_authored_depth | 0 | 0 | 0 |
| 11 | `naeringsliv/bedriftseier` | needs_authored_depth | 0 | 0 | 0 |
| 12 | `naeringsliv/grunder` | needs_authored_depth | 0 | 0 | 0 |
| 13 | `naeringsliv/industrieier` | needs_authored_depth | 0 | 0 | 0 |
| 14 | `naeringsliv/investor` | needs_authored_depth | 0 | 0 | 0 |
| 15 | `scenekunst/dramaturg` | needs_authored_depth | 0 | 0 | 0 |
| 16 | `scenekunst/koreograf` | needs_authored_depth | 0 | 0 | 0 |
| 17 | `scenekunst/regissor` | needs_authored_depth | 0 | 0 | 0 |
| 18 | `scenekunst/scenekunstkurator` | needs_authored_depth | 0 | 0 | 0 |
| 19 | `scenekunst/skuespiller_danser` | needs_authored_depth | 0 | 0 | 0 |
