...
**Classification:** 148 ready / 11 needs_authored_depth / 40 not_a_standalone_world
**Livelihood-backed:** 15
**Exact governed-source matches:** 148
**Multi-scene narrative foundations:** 148
**Completed life-position Role Worlds:** 148
...
| ---: | --- | --- | ---: | ---: | ---: |
| 1 | `musikk/artist` | needs_authored_depth | 0 | 0 | 0 |
| 2 | `musikk/frilansmusiker` | needs_authored_depth | 0 | 0 | 0 |
| 3 | `naeringsliv/bedriftseier` | needs_authored_depth | 0 | 0 | 0 |
| 4 | `naeringsliv/grunder` | needs_authored_depth | 0 | 0 | 0 |
| 5 | `naeringsliv/industrieier` | needs_authored_depth | 0 | 0 | 0 |
| 6 | `naeringsliv/investor` | needs_authored_depth | 0 | 0 | 0 |
| 7 | `scenekunst/dramaturg` | needs_authored_depth | 0 | 0 | 0 |
| 8 | `scenekunst/koreograf` | needs_authored_depth | 0 | 0 | 0 |
| 9 | `scenekunst/regissor` | needs_authored_depth | 0 | 0 | 0 |
| 10 | `scenekunst/scenekunstkurator` | needs_authored_depth | 0 | 0 | 0 |
| 11 | `scenekunst/skuespiller_danser` | needs_authored_depth | 0 | 0 | 0 |
