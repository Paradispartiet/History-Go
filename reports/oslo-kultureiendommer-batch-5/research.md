...
All four places have concrete visitor addresses. The branch uses the repository's normative address-first Geonorge finder and saves each lookup with `tee` before records are created.
