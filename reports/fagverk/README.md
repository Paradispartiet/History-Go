...
- `subkultur-chapters-audit.json` — permanent kapittel- og profilgate for åtte kapitler, 24 moduler, 72 seksjoner, 216 unike fagavsnitt, 160 claimkoblinger, 48 stedskoblinger og tre eksplisitt uvaliderte geografiske kandidatprofiler.
