...
Politikk står `materialized`, `audited` og `chapters_in_progress`. Tolv av tretten fagområder har registrerte kapitler, mens ett fortsatt mangler fullverdig hovedkapittel. `Regimer og institusjoner`, `Valg, partier og velgeratferd`, `Offentlig politikk, beslutning og implementering`, `Internasjonal politikk, sikkerhet og samarbeid`, `Politisk økonomi, stat og marked`, `Statsvitenskapelig metode og sammenligning`, `Norsk politikk, EØS/EU og flernivåstyring`, `Rett, lov og rettssikkerhet`, `Fordeling, velferd og ulikhet` og `Konflikt, makt og sivilsamfunn` har egne briefs, påstandsregistre, avsnittssporing og permanente kapittelaudits. Faget har i tillegg permanente kvalitetsgater for 123 emner, 71 operative metoder, 123 mappingrader, 152 hooks, normal quizåpning, Knowledge-leveranse og canonical ID–navn-integritet for teoripersoner.
