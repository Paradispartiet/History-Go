...
This PR is intentionally stacked on the batch 7 branch because PR #1819 is still open.
...
- `monna_tandberg`: direct Det Norske Teatret employment was found, but the source pass was obituary/news-led and less clean than the five selected anchors.
- `sossen_krohg`: source pass emphasized Det Norske Teatret's theatre school more than a clean place/ensemble anchor, so she was held back.
...
```text
data/det-norske-teatret-people-batch-7-20260708
```

because PR #1819 is still open. Once #1819 is merged, this branch/PR should be retargeted to `main` or recreated cleanly from updated `main` if GitHub shows inherited diff.
