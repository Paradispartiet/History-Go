...
- Removed `loelva_historisk` as a separate physical place.
- Preserved Loelva as a sourced historical alias relation on canonical `alnaelva`.
...
- Protocol after migration: 202 verified/source-controlled Oslo places; 30 unresolved controls.
