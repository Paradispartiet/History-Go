# People of Places — Holmenkollen batch 20 validation
...
Fresh canonical repository searches were run against post-batch-19 current `main`. No existing canonical person record was found for the five selected ids, names, or relevant spelling variants.
