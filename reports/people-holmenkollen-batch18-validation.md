# People of Places — Holmenkollen batch 18 validation
...
Fresh canonical repository searches were run against post-batch-17 current `main`. No existing canonical person record was found for the five selected ids, names, or relevant spelling variants.
