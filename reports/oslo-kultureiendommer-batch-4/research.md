...
All three candidates have concrete Norwegian street addresses. The batch uses the repository's normative address-first Geonorge workflow and saves each lookup result with `tee` before records are written.
