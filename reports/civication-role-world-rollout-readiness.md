...
**Classification:** 81 rollout_ready / 2 needs_role_authored_work / 2 blocked
...
- **vitenskap/vitenskap_forskningsledelse** — research_education; rollout_ready; queue #1
...
| ---: | --- | --- | --- | --- | --- |
| 1 | `vitenskap/vitenskap_forskningsledelse` | rollout_ready | research_education | candidate_when_shared_work_is_real | situated_reputation |
| 2 | `vitenskap/vitenskap_institusjonsledelse` | needs_role_authored_work | research_education | candidate_when_shared_work_is_real | career:day_one, career:knowledge, career:mail, career:people |
| 3 | `vitenskap/vitenskap_undervisning_og_forskning` | needs_role_authored_work | research_education | not_required_for_rollout | career:day_one, career:knowledge, career:mail, career:people |
| 4 | `musikk/musikk_scene_og_produksjon` | blocked | creative_production | not_required_for_rollout | career:authority, career:day_one, career:knowledge, career:mail |
| 5 | `musikk/musikk_utoving_og_ensemble` | blocked | other | not_required_for_rollout | career:authority, career:day_one, career:knowledge, career:mail |
