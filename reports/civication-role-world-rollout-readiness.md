...
- **natur/natur_biologi_og_forskning** — research_education; rollout_ready; queue #1
...
| ---: | --- | --- | --- | --- | --- |
| 1 | `natur/natur_biologi_og_forskning` | rollout_ready | research_education | not_required_for_rollout | situated_reputation |
