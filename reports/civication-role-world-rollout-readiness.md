...
- **politikk/politikk_politisk_radgivning** — public_administration; rollout_ready; queue #1
...
| ---: | --- | --- | --- | --- | --- |
| 1 | `politikk/politikk_politisk_radgivning` | rollout_ready | public_administration | not_required_for_rollout | — |
