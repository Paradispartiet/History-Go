# Historie — teori-evidensgrunnlag V1

Status: **PASSED**

Dette er en streng geografisk pilot for å dokumentere hvordan teoriobjekter brukes mot validerte claims, kilder og cases. `evidence_ready` betyr at objektet består pilotkontrakten; det betyr ikke at teorien er universelt bevist eller uttømmende dokumentert.
...
| Jord, eiendom og patronasje: forklarings- og kildebane | 4 | 2 | 4 | 4 | evidence_ready |
...
| Fattigvesen, veldedighet og sosial kontroll | 4 | 2 | 5 | 4 | evidence_ready |
| Helse, epidemi og profesjonalisering | 5 | 3 | 6 | 5 | evidence_ready |
| Skole, folkedannelse og medborgerskap | 4 | 2 | 3 | 4 | evidence_ready |
| Barndom, familie og livsløp | 6 | 3 | 6 | 6 | evidence_ready |
| Institusjonalisering og avinstitusjonalisering | 5 | 2 | 4 | 5 | evidence_ready |
...
| Sosialforsikring, pensjon og universalisme | 3 | 2 | 5 | 3 | evidence_ready |
| Boligpolitikk og materiell velferd | 4 | 3 | 4 | 4 | evidence_ready |
...
| Markeder og markedsintegrasjon: forklarings- og kildebane | 4 | 4 | 6 | 4 | evidence_ready |
| Handel, sjøfart og kommersielle nettverk: forklarings- og kildebane | 5 | 3 | 5 | 5 | evidence_ready |
| Penger, kreditt, bank og finans: forklarings- og kildebane | 3 | 3 | 5 | 3 | evidence_ready |
| Eiendom, kapital og akkumulering: forklarings- og kildebane | 4 | 4 | 7 | 4 | evidence_ready |
...
- V5.5-teoriobjektene forblir frosne og står fortsatt med `evidence_ready: false`.
- V6-evidensstatus eies av det separate canonical registeret.
- Hvert pilotobjekt må bruke minst tre validerte claims, to cases, to kilder og to claim-typer.
- Alle claims må ha eksplisitt usikkerhet, alternativ fortolkning og en validert sted–claim–kildekobling.
- Ett sted eller én kilde kan aldri alene gjøre et teoriobjekt kvalifisert.
