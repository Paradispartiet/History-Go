...
The preceding PR generalized `tools/validate_lesespor.mts` from an Oslo-only validator to manifest-driven multi-scope validation. The active Etne collection is therefore checked through the same manifest contract as Oslo, including:
