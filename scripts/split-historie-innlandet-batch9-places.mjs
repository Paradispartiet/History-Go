// Split Historie Innlandet batch 9 place aggregate into one JSON file per place.
...
const sourceFile = 'places_historie_innlandet_batch9.json';
const sourceStem = 'places_historie_innlandet_batch9';
