...
export function auditReligionHistoryComparisonArticles({ writeReport = false, checkReport = true } = {}) {
  ...
  assert(isDeepStrictEqual(readiness.production_progress.completed_area_ids, ['theory_method', AREA_ID, 'west_asian_abrahamic', 'south_asian_religions', 'east_asian_religions']), 'De fem første Religion-områdene skal være komplette');
