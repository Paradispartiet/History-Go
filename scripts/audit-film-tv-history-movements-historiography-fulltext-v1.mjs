...
export function auditFilmTvHistoryMovementsHistoriographyFulltextV1({ writeReport = false, checkReport = true } = {}) {
  ...
  assert(statusEntry.editorialStatus === 'chapters_in_progress' && [OUTPUT_GATE, LATER_SOURCE_BRIEF_GATE, TELEVISION_FULLTEXT_GATE, DOCUMENTARY_SOURCE_BRIEF_GATE, DOCUMENTARY_FULLTEXT_GATE].includes(statusEntry.nextGate), 'Film & TV står ikke på neste enhets kildebriefport');
