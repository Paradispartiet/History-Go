...
export function auditFilmTvVariableInventoryV1({ write = false, check = true } = {}) {
  ...
  assert(['canonical_inventory_migration', 'canonical_inventory_migrated_existing_chapter_reaudit'].includes(status?.nextGate), 'Film & TV skal stå på canonical migrasjon eller kapittelreaudit etter gapdesign');
