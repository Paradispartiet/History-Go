// Split Historie Buskerud batch 4 place aggregate into one JSON file per place.
...
const sourceFile = 'places_historie_buskerud_batch4.json';
const sourceStem = 'places_historie_buskerud_batch4';
