...
const CLAIM_SOURCE_IDS = Object.freeze({
  'cw-animation-1': ['ftc20-openusd', 'ftc21-aces'],
  'cw-animation-2': ['ftc20-openusd'],
  'cw-animation-3': ['ftc21-aces'],
  'cw-animation-4': ['ftc20-openusd', 'ftc27-animation-guild-ai'],
  'cw-sustainability-1': ['ftc15-nfi-nes'],
  'cw-sustainability-2': ['ftc16-albert-calculator'],
  'cw-sustainability-3': ['ftc16-albert-calculator'],
  'cw-sustainability-4': ['ftc16-albert-calculator', 'ftc22-epic-icvfx'],
  'cw-casting-1': ['ftc08-screenskills-casting-director', 'ftc09-equity-auditions'],
  'cw-casting-2': ['ftc05-screenskills-director', 'ftc08-screenskills-casting-director'],
  'cw-casting-3': ['ftc09-equity-auditions'],
  'cw-casting-4': ['ftc10-sag-intimacy'],
  'cw-casting-5': ['ftc10-sag-intimacy'],
  'cw-casting-6': ['ftc05-screenskills-director', 'ftc28-screenskills-actor'],
  'cw-labour-1': ['ftc11-arbeidstilsynet-risk'],
  'cw-labour-2': ['ftc12-arbeidstilsynet-participation'],
  'cw-labour-3': ['ftc13-filmforbundet-work-contract'],
  'cw-labour-4': ['ftc13-filmforbundet-work-contract', 'ftc14-wga-credits'],
  'cw-ai-1': ['ftc23-unesco-ai-ethics', 'ftc27-animation-guild-ai'],
  'cw-ai-2': ['ftc23-unesco-ai-ethics'],
  'cw-ai-3': ['ftc24-wga-ai'],
  'cw-ai-4': ['ftc25-sag-digital-replicas', 'ftc26-usco-ai'],
  'cw-ai-5': ['ftc24-wga-ai', 'ftc27-animation-guild-ai'],
  'cw-management-1': ['ftc03-screenskills-production-manager', 'ftc04-screenskills-production-coordinator', 'ftc11-arbeidstilsynet-risk'],
  'cw-management-2': ['ftc03-screenskills-production-manager', 'ftc04-screenskills-production-coordinator', 'ftc11-arbeidstilsynet-risk'],
  'cw-management-3': ['ftc03-screenskills-production-manager'],
  'cw-management-4': ['ftc11-arbeidstilsynet-risk', 'ftc12-arbeidstilsynet-participation'],
  'cw-design-1': ['ftc06-screenskills-production-designer'],
  'cw-design-2': ['ftc06-screenskills-production-designer', 'ftc07-screenskills-costume-designer'],
  'cw-design-3': ['ftc03-screenskills-production-manager', 'ftc05-screenskills-director', 'ftc06-screenskills-production-designer', 'ftc07-screenskills-costume-designer'],
  'cw-design-4': ['ftc04-screenskills-production-coordinator', 'ftc06-screenskills-production-designer', 'ftc07-screenskills-costume-designer'],
  'cw-directing-1': ['ftc05-screenskills-director', 'ftc06-screenskills-production-designer', 'ftc07-screenskills-costume-designer'],
  'cw-directing-2': ['ftc05-screenskills-director'],
  'cw-directing-3': ['ftc05-screenskills-director', 'ftc10-sag-intimacy'],
  'cw-directing-4': ['ftc05-screenskills-director', 'ftc06-screenskills-production-designer', 'ftc07-screenskills-costume-designer'],
  'cw-access-1': ['ftc17-w3c-media-access'],
  'cw-access-2': ['ftc01-screenskills-development-producer', 'ftc02-bfi-short-funding', 'ftc18-w3c-planning-access'],
  'cw-access-3': ['ftc19-nrk-accessibility'],
  'cw-access-4': ['ftc17-w3c-media-access', 'ftc18-w3c-planning-access'],
  'cw-development-1': ['ftc01-screenskills-development-producer', 'ftc02-bfi-short-funding'],
  'cw-development-2': ['ftc02-bfi-short-funding'],
  'cw-development-3': ['ftc01-screenskills-development-producer', 'ftc02-bfi-short-funding'],
  'cw-development-4': ['ftc03-screenskills-production-manager', 'ftc04-screenskills-production-coordinator'],
  'cw-vfx-1': ['ftc20-openusd', 'ftc21-aces'],
  'cw-vfx-2': ['ftc20-openusd', 'ftc21-aces'],
  'cw-vfx-3': ['ftc22-epic-icvfx', 'ftc29-ilm-mandalorian-stagecraft'],
  'cw-vfx-4': ['ftc22-epic-icvfx', 'ftc29-ilm-mandalorian-stagecraft'],
  'cw-vfx-5': ['ftc16-albert-calculator', 'ftc22-epic-icvfx', 'ftc29-ilm-mandalorian-stagecraft']
});
...
export function buildFilmTvCreativeWorkTechnologyResponsibilityFulltextV1() {
  ...
  for (const topic of topicClaims.topic_briefs) {
    for (const planned of topic.planned_claims) {
      const claimSourceIds = CLAIM_SOURCE_IDS[planned.id];
      assert(Array.isArray(claimSourceIds) && claimSourceIds.length > 0, `Claim ${planned.id} mangler claimspesifikk evidensmapping`);
      assert(claimSourceIds.every((id) => topic.source_ids.includes(id)), `Claim ${planned.id} bruker en kilde utenfor emnets inspiserte kildegrunnlag`);
      topicByClaimId.set(planned.id, topic);
    }
  }
  assert(Object.keys(CLAIM_SOURCE_IDS).length === topicByClaimId.size, 'Claim-evidensmappingen må dekke nøyaktig de 48 planlagte claimene');
  assert(Object.keys(CLAIM_SOURCE_IDS).every((id) => topicByClaimId.has(id)), 'Claim-evidensmappingen inneholder en ukjent claim-ID');
  ...
  assert(claims.some((row) => row.source_ids.length < topicByClaimId.get(row.id).source_ids.length), 'Sluttclaimene kan ikke arve hele emnets kildeliste ukritisk');
