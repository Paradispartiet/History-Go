...
export function buildFilmTvExistingChapterReauditV1() {
  ...
  const laterLearningOrderGate = ['learning_order_plan_complete_first_chapter_source_brief', 'audiovisual_form_source_brief_complete_full_chapter_production'].includes(currentFilmStatus?.nextGate);
