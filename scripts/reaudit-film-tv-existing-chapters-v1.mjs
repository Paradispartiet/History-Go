...
export function buildFilmTvExistingChapterReauditV1() {
  ...
  const laterLearningOrderGate = currentFilmStatus?.nextGate === 'learning_order_plan_complete_first_chapter_source_brief'
    || /(?:source_brief_complete_full_chapter_production|full_chapter_complete_next_unit_source_brief|full_chapter_complete_completion_audit|maintenance_source_refresh_and_place_case_expansion)$/.test(currentFilmStatus?.nextGate || '');
