// Split Historie Innlandet batch 11 place aggregate into one JSON file per place.
...
const sourceFile = 'places_historie_innlandet_batch11.json';
const sourceStem = 'places_historie_innlandet_batch11';
