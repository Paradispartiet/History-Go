// Split Historie Vestfold batch 4 place aggregate into one JSON file per place.
...
const sourceFile = 'places_historie_vestfold_batch4.json';
const sourceStem = 'places_historie_vestfold_batch4';
