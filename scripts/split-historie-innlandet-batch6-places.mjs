// Split Historie Innlandet batch 6 place aggregate into one JSON file per place.
...
const sourceFile = 'places_historie_innlandet_batch6.json';
const sourceStem = 'places_historie_innlandet_batch6';
