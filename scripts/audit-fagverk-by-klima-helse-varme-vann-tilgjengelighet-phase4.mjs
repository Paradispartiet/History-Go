...
export async function auditByKlimaHelseVarmeVannTilgjengelighetPhase4({writeReport=false,checkReport=true}={}){
 ...
 assert(rs&&Array.isArray(rs.chapters)&&rs.chapters.length===15,'Klima og helse-batch skal gi fjorten By-kapitler');
 ...
 assert(model.chapters.length===15,'Normalisert By skal ha fjorten kapitler');
