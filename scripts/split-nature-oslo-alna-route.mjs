// Split Oslo nature Alna route aggregate into one JSON file per place.
...
const sourceFile = 'places_oslo_natur_alnaelva_rute.json';
const sourceStem = 'places_oslo_natur_alnaelva_rute';
