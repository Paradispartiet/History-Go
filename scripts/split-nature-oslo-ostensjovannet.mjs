// Split Oslo nature Ostensjovannet aggregate into one JSON file per place.
...
const sourceFile = 'places_oslo_natur_ostensjovannet.json';
const sourceStem = 'places_oslo_natur_ostensjovannet';
