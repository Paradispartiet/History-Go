// Split Historie Akershus batch 3 place aggregate into one JSON file per place.
...
const sourceFile = 'places_historie_akershus_batch3.json';
const sourceStem = 'places_historie_akershus_batch3';
