// Split Historie Akershus batch 5 place aggregate into one JSON file per place.
...
const sourceFile = 'places_historie_akershus_batch5.json';
const sourceStem = 'places_historie_akershus_batch5';
