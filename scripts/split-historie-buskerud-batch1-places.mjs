// Split Historie Buskerud batch 1 place aggregate into one JSON file per place.
...
const sourceFile = 'places_historie_buskerud_batch1.json';
const sourceStem = 'places_historie_buskerud_batch1';
