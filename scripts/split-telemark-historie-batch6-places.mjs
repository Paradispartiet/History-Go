// Split Telemark history batch 6 aggregate into one JSON file per place.
...
const sourceFile = 'places_historie_telemark_batch6.json';
const sourceStem = 'places_historie_telemark_batch6';
