// Split Historie Innlandet batch 7 place aggregate into one JSON file per place.
...
const sourceFile = 'places_historie_innlandet_batch7.json';
const sourceStem = 'places_historie_innlandet_batch7';
