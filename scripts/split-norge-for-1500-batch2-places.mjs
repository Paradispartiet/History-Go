// Split Norge før 1500 batch 2 aggregate into one JSON file per place.
...
const sourceFile = 'places_historie_norge_for_1500_batch2.json';
const sourceStem = 'places_historie_norge_for_1500_batch2';
