...
export function auditFilmTvAudiovisualFormFulltextV1({ writeReport = false, checkReport = true } = {}) {
  ...
  assert(statusEntry.editorialStatus === 'chapters_in_progress' && statusEntry.nextGate === 'audiovisual_form_full_chapter_complete_next_unit_source_brief', 'Film & TV står ikke på neste kildebriefport');
