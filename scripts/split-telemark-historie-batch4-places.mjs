// Split Telemark historie batch 4 aggregate into one JSON file per place.
...
const sourceFile = 'places_historie_telemark_batch4.json';
const sourceStem = 'places_historie_telemark_batch4';
