// Split Historie Innlandet batch 8 place aggregate into one JSON file per place.
...
const sourceFile = 'places_historie_innlandet_batch8.json';
const sourceStem = 'places_historie_innlandet_batch8';
