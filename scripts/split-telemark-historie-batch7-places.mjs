// Split Telemark historie batch 7 aggregate into one JSON file per place.
...
const sourceFile = 'places_historie_telemark_batch7.json';
const sourceStem = 'places_historie_telemark_batch7';
