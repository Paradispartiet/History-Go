...
export function auditFilmTvCurriculumCompletenessV1({ writeReport = false, checkReport = true } = {}) {
  ...
  const migratedLegacyGates = new Set([
  ...
  const isLaterProductionGate = /(?:source_brief_complete_full_chapter_production|full_chapter_complete_next_unit_source_brief|full_chapter_complete_completion_audit|maintenance_source_refresh_and_place_case_expansion)$/.test(status?.nextGate || '');
