// Split Oslo nature Ljanselva route aggregate into one JSON file per place.
...
const sourceFile = 'places_oslo_natur_ljanselva_rute.json';
const sourceStem = 'places_oslo_natur_ljanselva_rute';
