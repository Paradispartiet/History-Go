...
export async function auditByBylivOffentligeRomPhase4({ writeReport = false, checkReport = true } = {}) {
  ...
  assert(registrySubject.chapters.length === 1, 'Første By Fase 4-batch skal registrere nøyaktig ett kapittel');
  ...
  assert(model.chapters.length === 1, 'Normalisert By-modell skal vise ett kapittel');
