// Split Agder history batch 2 aggregate into one JSON file per place.
...
const sourceFile = 'places_historie_agder_batch2.json';
const sourceStem = 'places_historie_agder_batch2';
