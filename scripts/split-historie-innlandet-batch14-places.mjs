// Split Historie Innlandet batch 14 place aggregate into one JSON file per place.
...
const sourceFile = 'places_historie_innlandet_batch14.json';
const sourceStem = 'places_historie_innlandet_batch14';
