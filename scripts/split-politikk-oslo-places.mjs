...
const outDir = join(root, 'data/places/politikk/oslo');
const sourceFile = 'places_politikk.json';
const sourceStem = 'places_politikk';
...
if (!Array.isArray(places)) {
  throw new Error(`Expected data/places/politikk/oslo/${sourceFile} to be a JSON array.`);
}
...
const manifest = {
  ...
  source_path: `data/places/politikk/oslo/${sourceFile}`,
...
const report = [
  ...
  '',
  `Source: data/places/politikk/oslo/${sourceFile}`,
