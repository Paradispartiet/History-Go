// Split Oslo nature hovedsteder aggregate into one JSON file per place.
...
const sourceFile = 'places_oslo_natur_hovedsteder.json';
const sourceStem = 'places_oslo_natur_hovedsteder';
