// Split Oslo nature Bygdoy aggregate into one JSON file per place.
...
const sourceFile = 'places_oslo_natur_bygdoy.json';
const sourceStem = 'places_oslo_natur_bygdoy';
