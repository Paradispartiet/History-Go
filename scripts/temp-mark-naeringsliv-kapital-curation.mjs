...
const domainId = "kapital_eierskap_finans";
...
delete pensum.summary.remaining_core_emnes_for_individual_curation;
pensum.summary = {
  ...pensum.summary,
  individually_curated_core_emne_count: 18,
  remaining_core_emne_count: 18
};
