...
BRANCH='agent/scenekunst-oslo-split-venues-01-readybuild'
...
printf '%s\n' '== Remove temporary runner files and publish clean feature commit =='
git checkout origin/main -- scripts/check-places.sh
git rm .github/workflows/scenekunst-oslo-split-venues-readybuild.yml
