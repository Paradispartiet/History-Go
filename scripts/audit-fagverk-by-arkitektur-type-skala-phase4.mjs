...
export async function auditByArkitekturTypeSkalaPhase4({ writeReport = false, checkReport = true } = {}) {
  ...
  assert(registrySubject.chapters.length === 9, 'Første Arkitektur-batch skal gi nøyaktig ni registrerte By-kapitler totalt');
  ...
  const report = {
    ...
    gates: {
      ...
      firstArchitectureChapterPreservedAcrossNineChapterRegistry: true,
