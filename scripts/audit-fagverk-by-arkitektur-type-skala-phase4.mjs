...
export async function auditByArkitekturTypeSkalaPhase4({ writeReport = false, checkReport = true } = {}) {
  ...
  assert(registrySubject.chapters.length === 11, 'Første Arkitektur-batch skal gi nøyaktig ni registrerte By-kapitler totalt');
  ...
  const report = {
    ...
    gates: {
      ...
      firstArchitectureChapterPreservedAcrossElevenChapterRegistry: true,
