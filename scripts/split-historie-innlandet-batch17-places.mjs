// Split Historie Innlandet batch 17 place aggregate into one JSON file per place.
...
const sourceFile = 'places_historie_innlandet_batch17.json';
const sourceStem = 'places_historie_innlandet_batch17';
