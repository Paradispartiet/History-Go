// Split Historie Innlandet batch 15 place aggregate into one JSON file per place.
...
const sourceFile = 'places_historie_innlandet_batch15.json';
const sourceStem = 'places_historie_innlandet_batch15';
