...
export function auditFilmTvNarrativeViewpointGenreSourceBriefV1({ writeFiles = false, checkFiles = true } = {}) {
  ...
  assert([INPUT_GATE, SOURCE_BRIEF_GATE, FULLTEXT_GATE, LATER_SOURCE_BRIEF_GATE, LATER_FULLTEXT_GATE, HISTORY_SOURCE_BRIEF_GATE, HISTORY_FULLTEXT_GATE].includes(currentGate), `Uventet Film & TV-port: ${currentGate}`);
  if ([FULLTEXT_GATE, LATER_SOURCE_BRIEF_GATE, LATER_FULLTEXT_GATE, HISTORY_SOURCE_BRIEF_GATE, HISTORY_FULLTEXT_GATE].includes(currentGate)) {
