...
export function auditReligionUniversityReadiness({ writeReport = false, checkReport = true } = {}) {
  ...
  const report = {
    ...
    gates: {
      ...
      firstTenUniversityAreasCompleteAtHighQuality: progress.quality_score >= 27
    }
  };
