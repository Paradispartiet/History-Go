...
export function auditReligionSouthAsianArticles({ writeReport = false, checkReport = true } = {}) {
  ...
  assert(isDeepStrictEqual(readiness.production_progress.completed_area_ids, ['theory_method', 'history_comparison', 'west_asian_abrahamic', AREA_ID, 'east_asian_religions', 'indigenous_sami', 'ritual_materiality_space', 'texts_myths_authority']), 'Eksakt åtte Religion-områder skal være komplette');
