// Split Historie Innlandet batch 18 place aggregate into one JSON file per place.
...
const sourceFile = 'places_historie_innlandet_batch18.json';
const sourceStem = 'places_historie_innlandet_batch18';
