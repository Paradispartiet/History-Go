// Split Historie Innlandet batch 4 place aggregate into one JSON file per place.
...
const sourceFile = 'places_historie_innlandet_batch4.json';
const sourceStem = 'places_historie_innlandet_batch4';
