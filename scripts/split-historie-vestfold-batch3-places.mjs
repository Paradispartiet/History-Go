// Split Historie Vestfold batch 3 place aggregate into one JSON file per place.
...
const sourceFile = 'places_historie_vestfold_batch3.json';
const sourceStem = 'places_historie_vestfold_batch3';
