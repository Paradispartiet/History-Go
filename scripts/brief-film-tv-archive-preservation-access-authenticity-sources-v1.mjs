...
const UNIT_FOURTEEN_OR_LATER_GATES = new Set([OUTPUT_GATE, FULLTEXT_GATE, UNIT_FIFTEEN_SOURCE_GATE, UNIT_FIFTEEN_COMPLETION_AUDIT_GATE, MAINTENANCE_GATE]);
...
export function buildFilmTvArchivePreservationAccessAuthenticitySourceBriefV1() {
  ...
  const laterGateAlreadyActive = [FULLTEXT_GATE, UNIT_FIFTEEN_SOURCE_GATE, UNIT_FIFTEEN_COMPLETION_AUDIT_GATE, MAINTENANCE_GATE].includes(currentGate);
  ...
  const gates = {
    ...
    current_status_is_input_output_or_known_later_gate: [INPUT_GATE, OUTPUT_GATE, FULLTEXT_GATE, UNIT_FIFTEEN_SOURCE_GATE, UNIT_FIFTEEN_COMPLETION_AUDIT_GATE, MAINTENANCE_GATE].includes(currentGate),
