...
export function audit(){
  ...
  assert(/versjonere/u.test(boundary)&&/language identifiers/u.test(boundary)&&/database similarity scores/u.test(boundary),'Reproducibility/database-grense mangler');
