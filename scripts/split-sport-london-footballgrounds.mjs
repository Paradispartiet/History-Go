...
const outDir = join(root, 'data/places/sport/europa/england');
const sourceFile = 'footballgrounds_london.json';
const sourceStem = 'footballgrounds_london';
...
if (!Array.isArray(places)) {
  throw new Error(`Expected data/places/sport/europa/england/${sourceFile} to be a JSON array.`);
}
...
const manifest = {
  ...
  source_path: `data/places/sport/europa/england/${sourceFile}`,
...
const report = [
  ...
  '',
  `Source: data/places/sport/europa/england/${sourceFile}`,
