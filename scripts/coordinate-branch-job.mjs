...
if (sourcePlace.name !== 'Kornmagasinet på Akershus festning' || sourcePlace.year !== 1788 || sourcePlace.sourceObjectId !== 'osm-way:669390505') {
  throw new Error('Validated source place identity does not match expected batch-42 correction');
}
...
const report = {
  ...
  concurrentMainSafety: 'Only the oslo_kornmagasin row is replaced in the current aggregate/index/manifest, preserving concurrent Schous bryggeri and other main changes.',
