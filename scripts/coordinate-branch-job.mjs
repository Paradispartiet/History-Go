...
const REPORT_DIR = "reports/oslo-coordinate-control-batch-187-akershus-energipark-relocation-fresh";
...
if (oldEvidence.placeId !== PLACE_ID || oldEvidence.coordinateDecision !== "needs_identity_split") throw new Error("Unexpected stale Oslo evidence state");
