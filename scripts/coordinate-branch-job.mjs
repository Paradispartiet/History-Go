...
if (!placeManifest.files?.includes(placeRel)) throw new Error('Ekeberg place is not registered in place manifest.');
...
if (protocol.includes(`| \`${id}\` |`)) throw new Error('Ekeberg already has a coordinate protocol table row.');
