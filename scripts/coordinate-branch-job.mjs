...
const theoryEmneIds = domainTheories.map((item) => String(item.theory_id || '').replace(/^theory_/, 'em_'));
...
const report = {
  ...
  domain_id: domainId,
  counts: { concepts: domainConcepts.length, theories: domainTheories.length, emner: domainEmner.length },
