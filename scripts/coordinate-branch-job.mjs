...
const SOURCE_COMMIT = '86e0689e2b54f2314054fd95c42ebb19b04bad09';
...
async function fetchText(url) {
  ...
  for (let attempt = 1; attempt <= 3; attempt += 1) {
    try {
      const response = await fetch(url, { headers: { 'user-agent': 'History-Go-Brattholmen-rebase/1.0' } });
...
console.log(`Brattholmen conflict-free rebuild from ${SOURCE_COMMIT}`);
