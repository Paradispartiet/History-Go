...
source = source
  ...
  .replace(".replaceAll('batch-166-result.json', 'batch-169-result.json')", ".replaceAll('batch-166-result.json', 'batch-168-result.json')")
...
if (!source.includes(".replaceAll('batch-166-result.json', 'batch-168-result.json')")) {
  throw new Error('Could not keep Båntjern result filename on batch 168');
}
