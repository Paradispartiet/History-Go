...
const PLACE_REL = 'data/places/natur/vestland/jettegrytene_rullestad.json';
...
writeJson(FLORA_REL, [{
  ...
  taxonomy: {
    norsk_navn: 'Bjørneskjegg',
    latin_navn: 'Trichophorum cespitosum',
    klasse: 'Liliopsida',
    orden: 'Poales',
    familie: 'Cyperaceae',
    artskart_taxon_id: 138441
  },
  habitat: {
    biotop: ['myr', 'fuktig hei', 'kystlynghei', 'næringsfattig våtmark'],
    jord: ['sur, våt og næringsfattig torv- eller mineraljord'],
    lys: ['åpent'],
    fukt: ['fuktig til vått']
  },
  fenologi: {
...
writeJson(FAUNA_REL, [{
  ...
  taxonomy: {
    norsk_navn: 'Blågrått kveldfly',
    latin_navn: 'Acronicta cinerea',
    klasse: 'Insecta',
    orden: 'Lepidoptera',
    familie: 'Noctuidae',
    artskart_taxon_id: 78526
  },
  habitat: {
    biotop: ['åpne biotoper', 'hei', 'skogkanter', 'bjørkebelte i fjellet'],
    jord: ['vegetasjonsdekt fastmark og hei'],
    lys: ['åpent til halvåpent'],
    fukt: ['tørr til frisk mark']
  },
  fenologi: {
...
places[0].data_quality = {
  ...
  analysisScope: '240 meter local square around canonical History GO area anchor',
  rawObservationCount: 6,
  acceptedObservationCount: 6,
  matchedFloraCount: 5,
  matchedFaunaCount: 1,
  unmatchedTaxaCount: 0,
  note: 'Local geosite analysis surface, not an official protected-area boundary.'
};
...
console.log('Jettegrytene species published: four existing cards and two new cards');
