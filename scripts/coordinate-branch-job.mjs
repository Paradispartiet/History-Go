...
console.log(JSON.stringify({ researchRun: 'standard-gml-direct-building-number-v2', exactMatches, attempts: attempts.map((attempt) => ({ number: attempt.number, method: attempt.method, status: attempt.status, parsed: attempt.parsed, candidateNumbersFound: attempt.candidateNumbersFound })) }, null, 2));
