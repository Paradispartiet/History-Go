...
const reportRel = 'reports/oslo-coordinate-bygdoy-roykenvika-retirement-post-195-v2';
...
await fs.writeFile(path.join(root, reportRel, 'README.md'), `# Fresh-main retirement of Bygdøy Røykensvika\n\n- Decision: **retired_unsubstantiated_identity**\n- Coordinate selected: **no**\n- Active references remaining: **0**\n- Supersedes stale PR: **#3642**\n- Next queue candidate: **bygdoy_kongsgard_salamanderdam**\n`, 'utf8');
