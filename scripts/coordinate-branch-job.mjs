...
run('python3', ['scripts/agent_sprakatlas_research_coverage_v1.py']);
...
if (fs.existsSync('scripts/agent_sprakatlas_research_coverage_v1.py')) {
  fs.rmSync('scripts/agent_sprakatlas_research_coverage_v1.py');
}
