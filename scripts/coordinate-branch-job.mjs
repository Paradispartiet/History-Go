...
const cleanupMarker = "  'scripts/coordinate-branch-job.mjs'";
const cleanupReplacement = [
  "  'scripts/.tid-curation-runner.gz.b64',",
  "  'scripts/.tid-curation-runner.gz.b64.00',",
  "  'scripts/.tid-curation-runner.gz.b64.01',",
  cleanupMarker
].join('\n');
if (!source.includes(cleanupMarker)) throw new Error('Fant ikke runnerens oppryddingspunkt');
