...
if (ids.some((id) => protocol.includes(`\`${id}\``))) throw new Error('One or more Bjørvika production IDs are already registered.');
...
write('reports/visitoslo-bjorvika-audit-20260721/production.json', {
  placeIds: ids,
  firstBatch,
  lastBatch,
