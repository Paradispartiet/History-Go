...
// Remove the misplaced Ekeberg row wherever it currently appears, and remove its stale batch-74 narrative.
...
protocol = protocol.replace(
  ...
  `Oslo-tabellen inneholder nå ${currentCount} verifiserte eller kildekontrollerte canonical steder. Batch ${nextBatch} flytter Helleristningene på Ekeberg fra en feilplassert batch-74-rad i Etne-tabellen til riktig Oslo-tabell. Totalantallet endres ikke fordi stedet allerede var canonical og medregnet. Antallet fullførte kontroller uten godkjent Oslo-koordinat er 29.`
);

protocol = `${protocol.trimEnd()}\n\nBatch ${nextBatch} (2026-07-20) retter protokollplasseringen for \`${id}\`. Den opprinnelige produksjonsmergen la batch-74-raden nederst i Etne-tabellen; FRIGO tok senere korrekt Oslo-batch 74 og Galleri MAP batch 75. Denne reparasjonen fjerner den feilplasserte raden og den gamle batch-74-teksten og registrerer Ekeberg i riktig Oslo-tabell på neste ledige batch. Canonical place, runtime-identitet, coordinate evidence og den Riksantikvaren-verifiserte geometrien \`kulturminnesok:41907\` endres ikke, og Oslo-totalen forblir ${currentCount}.\n`;
