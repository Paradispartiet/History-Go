...
const patched = original
  .replace(resetLine, "console.log('[Batch 102] Running on the fresh PR branch without moving HEAD.');")
  .replace(oldIndexBlock, newIndexBlock);
const tempPath = '/tmp/history-go-havnelageret-batch-102-automerge.mjs';
