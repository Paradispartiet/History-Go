...
const expectedBase64Sha = "9090147a691bf54fab8ad31e1f478c32ac4e94ead59d91fb6d6e5b35def5a5fe";
...
if (gzipSha !== "c277023d86e544f646a73ced5a7db5662218dcb077ef4ce991968d4bd84139b9") {
  throw new Error(`Builder gzip SHA-256 mismatch: ${gzipSha}`);
}
const source = gunzipSync(gzipBytes);
const sourceSha = createHash("sha256").update(source).digest("hex");
if (sourceSha !== "83ec2d5f728cc6c9351fe893021f561b5dad6c2bec60183b856f73b0eb66d374") {
