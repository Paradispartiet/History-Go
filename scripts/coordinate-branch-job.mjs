...
fs.writeFileSync(path.join(reportDir, 'middelalder-kirke-kongemakt-target-inventory.json'), `${JSON.stringify(report, null, 2)}\n`);
fs.rmSync(path.join(reportDir, 'middelalder-kirke-kongemakt-inventory.json'), { force: true });
