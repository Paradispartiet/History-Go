...
let narrativeIndex = lines.findIndex((line) => line.startsWith('Batch 116 (2026-07-21)'));
if (narrativeIndex < 0) narrativeIndex = lines.findIndex((line) => line.includes('Batch 116') && line.includes('Oslofjord'));
...
console.log('Synced validated Oslo Golfklubb payload as coordinate batch 117 after Oslofjord Akershus update.');
