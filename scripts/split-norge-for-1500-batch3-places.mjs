// Split Norway before 1500 batch 3 aggregate into one JSON file per place.
...
const sourceFile = 'places_historie_norge_for_1500_batch3.json';
const sourceStem = 'places_historie_norge_for_1500_batch3';
