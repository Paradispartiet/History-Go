// Split Historie Ostfold batch 2 place aggregate into one JSON file per place.
...
const sourceFile = 'places_historie_ostfold_batch2.json';
const sourceStem = 'places_historie_ostfold_batch2';
