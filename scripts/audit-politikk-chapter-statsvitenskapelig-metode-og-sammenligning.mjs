...
const P = Object.freeze({
  chapter: 'data/fagverk/politikk/statsvitenskapelig-metode-og-sammenligning.json',
  brief: 'data/fagverk/politikk/statsvitenskapelig-metode-og-sammenligning/brief.json',
  claims: 'data/fagverk/politikk/statsvitenskapelig-metode-og-sammenligning/claims.json',
  module1: 'data/fagverk/politikk/statsvitenskapelig-metode-og-sammenligning/01-grunnlag.json',
  module2: 'data/fagverk/politikk/statsvitenskapelig-metode-og-sammenligning/02-fordypning.json',
  module3: 'data/fagverk/politikk/statsvitenskapelig-metode-og-sammenligning/03-anvendelse.json',
  ...
  report: 'reports/fagverk/politikk-statsvitenskapelig-metode-og-sammenligning-audit.json'
});
...
export function auditPolitikkStatsvitenskapeligMetodeOgSammenligningChapter({ writeReport = false, checkReport = true } = {}) {
  ...
  const domain = (pensum.domains || []).find((row) => row.domain_id === 'statsvitenskapelig_metode_og_sammenligning');
  assert(domain, 'Pensum mangler fagområdet statsvitenskapelig metode og sammenligning');
  ...
  assert(chapter.id === 'statsvitenskapelig-metode-og-sammenligning' && chapter.chapter_id === chapter.id, 'Kapittel-ID er usynkron');
  ...
  assert(equalSet(chapter.method_ids || [], domain.method_ids || []), 'Kapittelet dekker ikke nøyaktig fagområdets fem metoder');
  ...
  const report = {
    schema: 'history_go_politikk_chapter_statsvitenskapelig_metode_og_sammenligning_audit_v1',
...
if (process.argv[1] && path.resolve(process.argv[1]) === fileURLToPath(import.meta.url)) {
  ...
  try {
    const report = auditPolitikkStatsvitenskapeligMetodeOgSammenligningChapter({ writeReport: args.has('--write-report'), checkReport: !args.has('--no-check-report') });
