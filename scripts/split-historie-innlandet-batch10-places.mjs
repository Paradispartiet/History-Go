// Split Historie Innlandet batch 10 place aggregate into one JSON file per place.
...
const sourceFile = 'places_historie_innlandet_batch10.json';
const sourceStem = 'places_historie_innlandet_batch10';
