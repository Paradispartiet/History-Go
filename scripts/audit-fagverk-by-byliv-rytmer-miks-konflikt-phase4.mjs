...
export async function auditByBylivRytmerMiksKonfliktPhase4({ writeReport = false, checkReport = true } = {}) {
  ...
  assert(registrySubject.chapters.length === 7, 'By skal ha fem Byliv-kapitler og ett Arkitektur-kapittel etter Arkitektur-start');
  ...
  const report = {
    ...
    gates: {
      ...
      fiveBylivChaptersPreservedAcrossSevenChapterRegistry: true,
