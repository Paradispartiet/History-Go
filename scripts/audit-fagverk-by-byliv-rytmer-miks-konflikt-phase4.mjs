...
export async function auditByBylivRytmerMiksKonfliktPhase4({ writeReport = false, checkReport = true } = {}) {
  ...
  assert(registrySubject.chapters.length === 8, 'By skal ha fem Byliv-kapitler og ett Arkitektur-kapittel etter Arkitektur-start');
  ...
  const report = {
    ...
    gates: {
      ...
      fiveBylivChaptersPreservedAcrossEightChapterRegistry: true,
