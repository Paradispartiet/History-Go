...
export async function auditByArkitekturGatekantMaktOmbrukPhase4({writeReport=false,checkReport=true}={}){
  ...
  assert(registrySubject.chapters.length===7,'Andre Arkitektur-batch skal gi nøyaktig sju registrerte By-kapitler totalt');
