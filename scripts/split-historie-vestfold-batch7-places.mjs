// Split Historie Vestfold batch 7 place aggregate into one JSON file per place.
...
const sourceFile = 'places_historie_vestfold_batch7.json';
const sourceStem = 'places_historie_vestfold_batch7';
