...
export function auditKunstPhase3({ writeReport = false, checkReport = true } = {}) {
  ...
  assert(statusEntry?.editorialStatus === 'chapters_in_progress', 'Kunst må stå chapters_in_progress etter første kapittel');
  ...
  assert(model.chapters.length === 1, 'Kunst skal ha nøyaktig ett registrert kapittel i første produksjonssteg');
