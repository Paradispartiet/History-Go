...
export function auditMediaPresseRedaksjonerAvishusPhase4({ writeReport = false, checkReport = true } = {}) {
  ...
  assert(registrySubject.chapters.length === 1 && registryChapter, 'Media-registeret skal ha nøyaktig ett kapittel');
  ...
  assert(phase3.report.summary.registeredChapterCount === 1, 'Fase 3-auditen ser ikke det første Media-kapittelet');
