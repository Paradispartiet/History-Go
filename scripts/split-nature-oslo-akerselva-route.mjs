// Split Oslo nature Akerselva route aggregate into one JSON file per place.
...
const sourceFile = 'places_oslo_natur_akerselvarute.json';
const sourceStem = 'places_oslo_natur_akerselvarute';
