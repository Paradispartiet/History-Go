...
if (check) {
  if (!fs.existsSync(reportFullPath) || fs.readFileSync(reportFullPath, 'utf8') !== report) {
    console.error(`${REPORT_PATH} is stale. Run npm run civication:badge-career-matrix and commit the result.`);
    process.exit(1);
  }
