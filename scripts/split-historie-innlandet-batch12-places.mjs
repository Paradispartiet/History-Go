// Split Historie Innlandet batch 12 place aggregate into one JSON file per place.
...
const sourceFile = 'places_historie_innlandet_batch12.json';
const sourceStem = 'places_historie_innlandet_batch12';
