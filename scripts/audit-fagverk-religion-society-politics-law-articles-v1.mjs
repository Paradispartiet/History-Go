...
export function auditReligionSocietyPoliticsLawArticles({ writeReport = false, checkReport = true } = {}) {
  ...
  assert(isDeepStrictEqual(readiness.production_progress.completed_area_ids, ['theory_method', 'history_comparison', 'west_asian_abrahamic', 'south_asian_religions', 'east_asian_religions', 'indigenous_sami', 'ritual_materiality_space', 'texts_myths_authority', AREA_ID, 'lived_identity_migration', 'secular_new_media']), 'Eksakt elleve Religion-områder skal være komplette');
