// Split Historie Innlandet batch 16 place aggregate into one JSON file per place.
...
const sourceFile = 'places_historie_innlandet_batch16.json';
const sourceStem = 'places_historie_innlandet_batch16';
