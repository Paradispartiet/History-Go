// Split Eastern Norway motorsport aggregate into one JSON file per place.
...
const sourceFile = 'places_motorsport_ostlandet.json';
const sourceStem = 'places_motorsport_ostlandet';
