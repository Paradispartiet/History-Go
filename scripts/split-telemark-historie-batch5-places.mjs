// Split Telemark history batch 5 aggregate into one JSON file per place.
...
const sourceFile = 'places_historie_telemark_batch5.json';
const sourceStem = 'places_historie_telemark_batch5';
