// Split Telemark historie batch 1 aggregate into one JSON file per place.
...
const sourceFile = 'places_historie_telemark_batch1.json';
const sourceStem = 'places_historie_telemark_batch1';
