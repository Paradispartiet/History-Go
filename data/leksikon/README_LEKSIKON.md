...
| Språkleksikon, tolkning, klassifikasjon, legacy-objekter | **Mer** |
...
`data/leksikon/sprak/manifest.json` og de stedsspesifikke språkfilene beholdes.

Språkleksikon vises under **Mer** fordi det er et smalere kunnskapslag, ikke en egen PlaceCard-runding.
...
`js/ui/place-popup-tabs.js` er nå den primære brukerrettede adapteren som leser disse dataene inn i stedspopupens faner.
