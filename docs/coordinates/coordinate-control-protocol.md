...
| 190 | `fornebu_teknologipark` | IT Fornebu – Terminalbygget | verified; moved to Akershus | `geonorge-adresser-v1:3201:1566:25` |

Batch 190 (2026-07-23) løser `fornebu_teknologipark` ved geografisk og identitetsmessig korrigering. Den brede legacy-markøren «Fornebu Teknologipark» lå i Oslo-kilden selv om det dokumenterte stedet ligger i Bærum. Source-first-researchen avgrenser stedet til det tidligere terminalbygget på Oslo lufthavn Fornebu, senere brukt som IT Fornebu og kunnskaps-/teknologimiljø. Geonorge gir ett eksakt adresseobjekt for Martin Linges vei 25. PlaceId beholdes for eksisterende quiz- og relasjonskoblinger, mens canonical record og evidens flyttes til Akershus.
