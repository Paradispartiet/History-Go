...
Oslo-tabellen inneholder nå 223 verifiserte eller kildekontrollerte canonical steder. Batch 76 flytter Helleristningene på Ekeberg fra en feilplassert batch-74-rad i Etne-tabellen til riktig Oslo-tabell. Totalantallet endres ikke fordi stedet allerede var canonical og medregnet. Antallet fullførte kontroller uten godkjent Oslo-koordinat er 29.
...
Batch 76 (2026-07-20) retter protokollplasseringen for `ekeberg_helleristninger`. Den opprinnelige produksjonsmergen la batch-74-raden nederst i Etne-tabellen; FRIGO tok senere korrekt Oslo-batch 74 og Galleri MAP batch 75. Denne reparasjonen fjerner den feilplasserte raden og den gamle batch-74-teksten og registrerer Ekeberg i riktig Oslo-tabell på neste ledige batch. Canonical place, runtime-identitet, coordinate evidence og den Riksantikvaren-verifiserte geometrien `kulturminnesok:41907` endres ikke, og Oslo-totalen forblir 223.
