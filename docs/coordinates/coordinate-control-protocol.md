...
Etne batch 4 (2026-07-21) bruker Miljødirektoratets offisielle vernepolygon som områdegeometri. Artskart-revisjonen bruker den samme polygonen og er dokumentert i `reports/etne-natur-batch-5-skano-artskart.json`.
