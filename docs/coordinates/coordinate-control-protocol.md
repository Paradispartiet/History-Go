...
Oslo-tabellen inneholder nå 200 verifiserte eller kildekontrollerte canonical steder. Alias-recorden `loelva_historisk` er migrert til `alnaelva` uten å opprette eller verifisere et nytt fysisk sted. Antallet fullførte kontroller uten godkjent Oslo-koordinat er 31.
