...
| 195 | `frognerstranda` | Frognerstranda | verified_geometry | `oslo-kommune:frognerstranda:embedded-geojson-line` |

Batch 195 (2026-07-24) løser Frognerstranda som den brede lineære strandsonen Oslo kommune selv avgrenser fra den innerste delen av Frognerkilen/Bygdøy i vest til Hjortnes/Framnes i øst. Kommunens offisielle Frognerstranda-side eksponerer dette scope-et som én maskinlesbar GeoJSON LineString med 12 punkter og en lengde på ca. 1,63 km. Canonical lat/lon er det deterministiske lengdemidtpunktet langs samme kommunale linje. Locator-typen korrigeres fra `natural_area` til `linear_area`. Det separate kartpunktet på nettsiden, E18, jernbane, tilfeldige coastline-segmenter og den kortere eksakt navngitte OSM-fotveien brukes ikke som proxy for hele strandsonen; legacy-punktet og nearest/first-hit brukes ikke.
