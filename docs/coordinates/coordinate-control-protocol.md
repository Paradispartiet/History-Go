...
Oslo-tabellen inneholder nå 199 verifiserte eller kildekontrollerte canonical steder. Duplikatet `nydalen_industristed` er migrert til `nydalen` uten å opprette et nytt fysisk sted. Antallet fullførte kontroller uten godkjent Oslo-koordinat er 32.
