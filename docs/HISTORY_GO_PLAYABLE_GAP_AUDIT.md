...
Dette dokumentet samler kjent gap mellom History GO som bygget system og History GO som ferdig spillbar app.
...
`docs/PLACE_STANDARD.md` definerer stedmodenhet slik:
...
Neste faktiske data-audit bør måle:
...
> Gjør det eksisterende History GO-spillet ferdig lesbart, spillbart og målbart før nye store systemer bygges.
