...
3. [`FILM_TV_CURRICULUM_COMPLETENESS_V1.md`](./FILM_TV_CURRICULUM_COMPLETENESS_V1.md) — aktiv Film & TV-refaktorport med migrert variabel canon, gapdekkende læringsrekkefølge og fulltekstproduksjon etter kontrollert kilde- og claimbrief
