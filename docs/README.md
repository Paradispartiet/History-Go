...
1. [`../data/fag/historie/historie_v5_contract.json`](../data/fag/historie/historie_v5_contract.json) — aktiv V5.7-fagmodell og versjonsspesifikke kvalitetsmål
...
5. [`../data/fag/historie/historie_v5_7_freeze_manifest.json`](../data/fag/historie/historie_v5_7_freeze_manifest.json) — aktivt V5.7-frysemanifest
6. [`../reports/historie-v5/historie-v5-7-quality-depth.json`](../reports/historie-v5/historie-v5-7-quality-depth.json) — materialisert V5.7-kvalitetsstatus
7. [`HISTORY_V5_5_FREEZE.md`](./HISTORY_V5_5_FREEZE.md) — historisk V5.5-baseline og forklaring av compatibility-navn

V5.7 er aktiv fagmodell. V5.5 og V5.6 er historiske, reproduserbare baselines. En grønn kvalitetsfrys beskytter et versjonert inventar, men er ikke det samme som universell `COMPLETE`; den uavhengige heldekningsrapporten er fortsatt autoritativ for hva som gjenstår.
...
- Historie V5.7 er dokumentert som aktiv autoritet; universell heldekning er canonical policy, og V5.5/V5.6 er historiske baselines
