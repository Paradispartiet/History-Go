...
| `lisbon_belem_bydel` | Belém | 1496 | `data/places/by/europe/portugal/lisbon/places_lisbon_by.json` |
...
| `frognerparken` | Frognerparken | 1900 | `data/places/by/oslo/places_by.json` |
| `gamlebyen` | Gamlebyen | 1000 | `data/places/by/oslo/places_by.json` |
| `lisbon_gare_do_cais_do_sodre` | Gare do Cais do Sodré | 1928 | `data/places/by/europe/portugal/lisbon/places_lisbon_by.json` |
| `lisbon_graca` | Graça | 1271 | `data/places/by/europe/portugal/lisbon/places_lisbon_by.json` |
| `grorud` | Grorud | 1950 | `data/places/by/oslo/places_by.json` |
...
| `kampen` | Kampen | 1880 | `data/places/by/oslo/places_by.json` |
| `kampen_kirke` | Kampen kirke | 1882 | `data/places/by/oslo/places_by.json` |
| `kampen_park` | Kampen park | 1915 | `data/places/by/oslo/places_by.json` |
...
| `lisbon_city` | Lisboa | 1147 | `data/places/by/europe/portugal/lisbon/places_lisbon_by.json` |
...
| `lisbon_martim_moniz_mouraria_axis` | Martim Moniz–Mouraria-aksen | 1147 | `data/places/by/europe/portugal/lisbon/places_lisbon_by.json` |
...
| `sagene` | Sagene | 1850 | `data/places/by/oslo/places_by.json` |
| `schous_plass` | Schous plass | 1881 | `data/places/by/oslo/places_by.json` |
| `skoyen` | Skøyen | 1900 | `data/places/by/oslo/places_by.json` |
...
| `voienvolden` | Vøienvolden | 1716 | `data/places/by/oslo/places_by.json` |
| `okern` | Økern | 1960 | `data/places/by/oslo/places_by.json` |

### film_tv (7 uten story)

| place_id | Navn | År | Place file |
|---|---|---:|---|
| `lisbon_cinema_ideal` | Cinema Ideal | 1904 | `data/places/film_tv/europe/portugal/lisbon/places_lisbon_film_tv.json` |
| `lisbon_cinema_nimas` | Cinema Nimas | 1976 | `data/places/film_tv/europe/portugal/lisbon/places_lisbon_film_tv.json` |
| `lisbon_cinema_sao_jorge` | Cinema São Jorge | 1950 | `data/places/film_tv/europe/portugal/lisbon/places_lisbon_film_tv.json` |
| `lisbon_cinemateca_portuguesa` | Cinemateca Portuguesa | 1948 | `data/places/film_tv/europe/portugal/lisbon/places_lisbon_film_tv.json` |
| `cinemateket_oslo` | Cinemateket i Oslo | 1956 | `data/places/popkultur/oslo/places_oslo_populaerkultur.json` |
...
| `lisbon_tobis_portuguesa` | Tobis Portuguesa | 1932 | `data/places/film_tv/europe/portugal/lisbon/places_lisbon_film_tv.json` |

### historie (40 uten story)
...
| `vaterland_historisk_elvelop` | Vaterland – historisk elveløp | 1650 | `data/places/natur/oslo/places_oslo_natur_akerselvarute.json` |
...
| place_id | Navn | År | Place file |
|---|---|---:|---|
| `aftenposten_akersgata` | Aftenposten i Akersgata | 1880 | `data/places/media/oslo/places_oslo_media.json` |
| `lisbon_antena_1_rdp` | Antena 1 / RDP-radiohistorie | 1935 | `data/places/media/europe/portugal/lisbon/places_lisbon_media.json` |
| `lisbon_arquivo_rtp` | Arquivo RTP | 1957 | `data/places/media/europe/portugal/lisbon/places_lisbon_media.json` |
| `dagbladet_akersgata` | Dagbladet i Akersgata | 1869 | `data/places/media/oslo/places_oslo_media.json` |
| `lisbon_diario_de_noticias` | Diário de Notícias-bygget | 1864 | `data/places/media/europe/portugal/lisbon/places_lisbon_media.json` |
...
| `vg_huset` | VG-huset | 1945 | `data/places/media/oslo/places_oslo_media.json` |
...
| `lisbon_jardim_da_estrela` | Jardim da Estrela | 1852 | `data/places/natur/europe/portugal/lisbon/places_lisbon_natur.json` |
...
| `lisbon_jardim_do_principe_real` | Jardim do Príncipe Real | 1860 | `data/places/natur/europe/portugal/lisbon/places_lisbon_natur.json` |
...
| `lisbon_miradouro_da_graca` | Miradouro da Graça (Sophia de Mello Breyner Andresen) | 1271 | `data/places/natur/europe/portugal/lisbon/places_lisbon_natur.json` |
| `lisbon_miradouro_da_senhora_do_monte` | Miradouro da Senhora do Monte | 1796 | `data/places/natur/europe/portugal/lisbon/places_lisbon_natur.json` |
...
| `lisbon_feira_da_ladra` | Feira da Ladra | 1882 | `data/places/popkultur/europe/portugal/lisbon/places_lisbon_populaerkultur.json` |
| `lisbon_feira_do_livro` | Feira do Livro de Lisboa | 1931 | `data/places/popkultur/europe/portugal/lisbon/places_lisbon_populaerkultur.json` |
| `folketeateret` | Folketeateret | 1935 | `data/places/popkultur/oslo/places_oslo_populaerkultur.json` |
...
| `lisbon_marchas_populares` | Marchas Populares de Lisboa | 1932 | `data/places/popkultur/europe/portugal/lisbon/places_lisbon_populaerkultur.json` |
| `saga_kino` | Saga kino | 1989 | `data/places/film/oslo/places_oslo_film.json` |
| `lisbon_santo_antonio_festival` | Santo António-festivalen i Lisboa | 1934 | `data/places/popkultur/europe/portugal/lisbon/places_lisbon_populaerkultur.json` |
...
| `lisbon_centro_nautico_de_belem` | Centro Náutico de Belém | 1856 | `data/places/sport/europe/portugal/lisbon/places_lisbon_sport.json` |
| `daelenenga_idrettspark` | Dælenenga idrettspark | 1916 | `data/places/sport/oslo/places_sport.json` |
...
| `frogner_stadion` | Frogner stadion | 1914 | `data/places/sport/oslo/places_sport.json` |
...
| `gressbanen` | Gressbanen | 1918 | `data/places/sport/oslo/places_sport.json` |
| `lisbon_hipodromo_do_campo_grande` | Hipódromo do Campo Grande | 1885 | `data/places/sport/europe/portugal/lisbon/places_lisbon_sport.json` |
...
| `nordre_aasen_idrettspark` | Nordre Åsen idrettspark | 1952 | `data/places/sport/oslo/places_sport.json` |
...
| `gamlebyen_skole` | Gamlebyen skole | 1799 | `data/places/vitenskap/oslo/places_vitenskap.json` |
...
| `rikshospitalet` | Rikshospitalet | 1826 | `data/places/vitenskap/oslo/places_vitenskap.json` |
