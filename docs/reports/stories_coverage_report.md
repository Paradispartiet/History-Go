...
- Places med minst én story: **31**.
- Places uten story: **439**.
- Total coverage: **6.6%**.
- Story-manifestet peker på **32** story-filer med **33** stories totalt. **33** stories har `place_id`, fordelt på **31** places.
...
| by | 100 | 7 | 93 | 7.0% |
| film_tv | 8 | 1 | 7 | 12.5% |
| historie | 54 | 10 | 44 | 18.5% |
| kunst | 18 | 1 | 17 | 5.6% |
| litteratur | 31 | 1 | 30 | 3.2% |
| media | 11 | 0 | 11 | 0.0% |
| musikk | 13 | 1 | 12 | 7.7% |
| naeringsliv | 41 | 0 | 41 | 0.0% |
| natur | 63 | 0 | 63 | 0.0% |
...
| by | `grand_hotel` | Grand Hotel | Ibsens daglige marsj til Grand Café | data/stories/stories_henrik_ibsen.json |
...
| by | `frognerstranda` | Frognerstranda |  | `data/places/popkultur/oslo/places_oslo_populaerkultur.json` |
...
| by | `slottsplassen` | Slottsplassen |  | `data/places/popkultur/oslo/places_oslo_populaerkultur.json` |
...
| historie | `middelalder_oslo` | Middelalderparken | 1050 | `data/places/historie/oslo/places_historie.json` |
...
| historie | `oslo_ladegard` | Oslo ladegård | 1725 | `data/places/historie/oslo/places_historie_added_batch_01.json` |
...
| historie | `prinds_christian_augusts_minde` | Prinds Christian Augusts Minde | 1809 | `data/places/historie/oslo/places_historie_added_batch_01.json` |
...
| historie | `villa_grande` | Villa Grande | 1917 | `data/places/historie/oslo/places_historie.json` |
...
| media | `nrk_huset_marienlyst` | NRK-huset på Marienlyst | 1938 | `data/places/media/oslo/places_oslo_media.json` |
...
| naeringsliv | `havnelageret` | Oslo Havnelager | 1921 | `data/places/naeringsliv/oslo/places_naeringsliv.json` |
...
| naeringsliv | `schous_bryggeri` | Schous bryggeri | 1837 | `data/places/naeringsliv/oslo/places_naeringsliv.json` |
...
| populaerkultur | `hartvig_nissens_skole_skam` | Hartvig Nissens skole (SKAM) | 1849 | `data/places/film/oslo/places_oslo_film.json` |
...
| sport | `ekebergsletta` | Ekebergsletta | 1972 | `data/places/sport/oslo/places_sport.json` |
...
| vitenskap | `botanisk_hage` | Botanisk hage | 1814 | `data/places/vitenskap/oslo/places_vitenskap.json` |
...
## Prioritert shortlist for Stories batch 4

Shortlisten under er en redaksjonell prioritering basert på eksisterende place-data, ikke ferdig research. Punktene beskriver hvorfor stedet sannsynligvis har høy story-verdi, hvilken retning en story kan undersøke, og hvilke kildetyper som bør sjekkes før eventuell story skrives.

| Prioritet | place_id | Navn | Kategori | Hvorfor story-potensial | Mulig story-retning | Foreslåtte kildetyper |
|---:|---|---|---|---|---|---|
| 1 | `middelalder_oslo` | Middelalderparken | historie | Synlige ruiner, byens eldste lag og flyttingen av bytyngdepunktet gir sterk fysisk forankring. | En kort fortelling om å stå i dagens park og lese middelalderbyens kirker, bosetting og maktlandskap. | Oslo byleksikon; Riksantikvaren/kulturminnedatabase; Oslo Museum; arkeologiske formidlingsartikler |
| 2 | `villa_grande` | Villa Grande | historie | Place-data kobler bygget til okkupasjon, Quisling og senere HL-senteret, altså en tydelig transformasjon i moralsk betydning. | Fra maktens residens under okkupasjonen til minne-, Holocaust- og menneskerettighetsinstitusjon. | HL-senteret; okkupasjonshistoriske arkiver; Oslo byleksikon; biografisk faglitteratur |
| 3 | `prinds_christian_augusts_minde` | Prinds Christian Augusts Minde | historie | Anlegget samler fattigomsorg, tvangsarbeid, asyl og institusjonshistorie på ett sted. | En sosialhistorisk story om omsorg og kontroll i samme bygårdskompleks. | Oslo byleksikon; Byantikvaren; lokalhistoriske artikler; arkivmateriale om fattigvesen og institusjoner |
| 4 | `galgeberg` | Galgeberg | historie | Navn og sted peker mot offentlig straff, rettshistorie og mørke byrom. | Hvordan et rettersted i byens utkant ble et varig stedsnavn og minnespor. | Oslo byleksikon; rettshistorisk litteratur; kart og lokalhistoriske kilder |
| 5 | `gamle_radhus` | Gamle rådhus | historie | Tidlig bystyre, borgerskap og rettsvesen gir politisk og institusjonell story-verdi. | Christianias gamle rådhus som scene for den nye byen etter 1600-tallets omforming. | Oslo byleksikon; Byantikvaren; kommunale historieverk; eldre kart |
| 6 | `oslo_ladegard` | Oslo ladegård | historie | Barokkbygget har lag fra kloster, bispegård og ladegård, og ligger tett på middelalderbyens spor. | Et hus som kan åpne flere tidslag i Gamlebyen, fra kirkelig makt til senere byhistorisk formidling. | Oslo byleksikon; Oslo ladegårds formidling; kulturminnedatabase; middelalderarkeologi |
| 7 | `bjorvika` | Bjørvika | by | Place-data beskriver en stor transformasjon fra havn/trafikk til kultur, bolig, kontor og fjordby. | En byutviklingsstory om da Oslo forsøkte å skrive om forholdet mellom sentrum og fjorden. | Plan- og bygningsetaten; Fjordbyen-dokumenter; Oslo byleksikon; avisarkiv |
| 8 | `christiania_torv` | Christiania Torv | by | Torvet er et lesbart punkt i Kvadraturen og den regulerte byen etter brannen. | Torvet som inngang til hvordan Christiania ble planlagt og synliggjort etter bybrannen. | Oslo byleksikon; Byantikvaren; historiske kart; kommunale byhistorier |
| 9 | `karl_johan` | Karl Johans gate | by | Hovedgate, paradeakse, demonstrasjonsrom og kobling mellom jernbane, Storting, universitet, teater og slott. | Gaten som offentlig scene: feiring, protest, hverdagsliv og nasjonal symbolikk i samme akse. | Oslo byleksikon; fotoarkiv; avisarkiv; politihistoriske/arrangementsarkiver |
| 10 | `oslo_s` | Oslo S | by | Norges største transportknutepunkt har høy fysisk play-verdi og mange lag av mobilitet, handel og sosialt byliv. | En story om knutepunktet som bymaskin: reiser, venting, ombygginger og menneskestrømmer. | Bane NOR/Jernbanemuseet; Oslo byleksikon; avisarkiv; planhistorikk |
| 11 | `slottsplassen` | Slottsplassen | by | Stedet er en tydelig nasjonal og fysisk scene ved Slottet. | Slottsplassen som seremonirom og politisk-symbolsk møtepunkt mellom statsmakt og publikum. | Det kongelige hoff; Oslo byleksikon; fotoarkiv; avisarkiv |
| 12 | `tinghuset` | Oslo tinghus | politikk | Domstolsbygg og rettsstatlig institusjon gir potensial for konflikter, oppgjør og rettslig offentlighet. | En story om hvordan rettsstatens arbeid blir synlig i sentrum gjennom rettssaler, presse og publikum. | Domstoladministrasjonen; Oslo tingrett; arkitekturhistorie; avisarkiv |
| 13 | `lisbon_largo_do_carmo` | Largo do Carmo | politikk | Place-data knytter plassen til Quartel do Carmo og en politisk vendepunktskontekst. | Plassen som kompakt scene for politisk overgang, folkemengder og en kaserne i sentrum. | Lisboa kommunale kilder; Museu do Aljube; portugisiske avisarkiv; historiske foto |
| 14 | `lisbon_convento_do_carmo` | Convento do Carmo | historie | Ruinen etter jordskjelvet gir et dramatisk fysisk spor og natur-/byhistorisk vendepunkt. | En story om hvordan en åpen ruin kan gjøre katastrofe, minne og byomforming synlig. | Museu Arqueológico do Carmo; Lisboa byhistorie; seismologiske/historiske kilder; kulturminnedatabase |
| 15 | `lisbon_castelo_de_sao_jorge` | Castelo de São Jorge | historie | Festningen har lang fortifikasjonshistorie og tydelig utsikt/fysisk orientering. | Borgen som utkikkspunkt for å lese erobring, forsvar og bykontroll over Lisboa. | Castelo de São Jorge; portugisiske kulturminnekilder; middelalderhistorie; kart |
| 16 | `lisbon_torre_de_belem` | Torre de Belém | historie | Forsvarstårn ved innseilingen har sterk fysisk form og maritim/politisk symbolikk. | Innseilingen som scene: forsvar, hav, handel og byens selvbilde. | UNESCO/kulturminnedatabase; portugisiske monumentkilder; maritime historiekilder |
| 17 | `lisbon_praca_do_comercio` | Praça do Comércio | by | Stor plass ved Tejo med post-jordskjelvsk byform og statlig/kommersiell symbolikk. | Fra katastrofe og gjenoppbygging til monumental handels- og maktplass ved elven. | Lisboa byhistorie; historiske kart; museumskilder om 1755; arkitekturhistorie |
| 18 | `lisbon_ponte_25_de_abril` | Ponte 25 de Abril | by | Broen har åpning, navne-/symbolendring og tydelig fysisk spor over Tejo. | En infrastrukturstory om bro, mobilitet og politisk minne i samme konstruksjon. | Broforvalter/tekniske kilder; Lisboa byleksikon/kommunale kilder; avisarkiv; fotoarkiv |
| 19 | `nrk_huset_marienlyst` | NRK-huset på Marienlyst | media | Statskringkastingens studioer og redaksjoner gir kultur-, teknologi- og offentlighetshistorie. | Marienlyst som stedet der radio, TV og nett blir produsert som nasjonal offentlighet. | NRK arkiv; mediehistorisk forskning; Oslo byleksikon; fotoarkiv |
| 20 | `hartvig_nissens_skole_skam` | Hartvig Nissens skole (SKAM) | populaerkultur | Place-data peker på en konkret innspillingslokasjon med sterk popkulturell gjenkjennelse. | Hvordan en skolefasade ble et sted fans leser som TV-fiksjon og ungdomskultur. | NRK/produksjonsintervjuer; pressearkiv; skolehistorie; fan-/resepsjonsforskning |
| 21 | `blaa` | Blå | musikk | Klubb- og konsertscene ved Akerselva kobler undergrunn, jazz/elektronika og industripreget byrom. | En nattlivs- og musikkscene-story om hvordan elvekanten ble kulturrom. | Scene-/programarkiv; musikkpresse; Oslo byleksikon; intervjuer |
| 22 | `ekebergsletta` | Ekebergsletta | sport | Norway Cup og breddeidrett gir mange konkrete øyeblikk, logistikk og internasjonalt møte på et fysisk felt. | En sportsstory om midlertidig fotballby, frivillighet og tusenvis av kamper. | Norway Cup-arkiv; idrettsforbund; lokalpresse; fotoarkiv |
| 23 | `botanisk_hage` | Botanisk hage | vitenskap | Levende plantesamling fra 1814 gir naturhistorie, vitenskap og tydelige fysiske spor. | En story om hagen som laboratorium, samling og offentlig bynatur. | Naturhistorisk museum/UiO; botaniske samlingskilder; Oslo byleksikon; hagehistorie |
| 24 | `observatoriet` | Observatoriet | vitenskap | Norges første astronomiske observatorium har tydelig vitenskapshistorisk arbeidssted og instrumenthistorie. | En story om meridianer, stjernemåling og presis tid i den tidlige universitetsbyen. | UiO Museum for universitets- og vitenskapshistorie; Oslo byleksikon; astronomihistorie; instrumentkataloger |
| 25 | `universitetets_gamle_kjemi` | Universitetets gamle kjemibygning | vitenskap | Place-data kobler bygget til Waage og Guldbergs massevirkningslov, altså et konkret forskningsgjennombrudd. | Laboratoriet som sted for eksperimentell metode og matematisk kjemi. | UiO-historie; kjemihistoriske artikler; SNL; universitetets arkiv |
| 26 | `nobelinstituttet` | Nobelinstituttet | vitenskap | Fredsprisens komitéarbeid, arkiv og globale konflikt-/diplomatihistorie gir høy story-verdi. | Bygget der Oslo kobles til internasjonal fredshistorie gjennom dokumenter og beslutninger. | Nobelinstituttet; Nobelprisens offisielle kilder; biografier; avisarkiv |
| 27 | `havnelageret` | Oslo Havnelager | naeringsliv | Havnebygg, importvarer og logistikk gjør byøkonomi fysisk og lesbar. | En story om kaia, lageret og hvordan kaffe, korn og kolonivarer kom inn i byen. | Oslo havn; Byantikvaren; næringslivshistorie; fotoarkiv |
| 28 | `schous_bryggeri` | Schous bryggeri | naeringsliv | Bryggeri som industriarbeidsplass og sosialt sentrum gir næringsliv, arbeiderhistorie og transformasjon. | Fra produksjonsanlegg og arbeidshverdag til byrom/ny bruk på Grünerløkka. | Oslo byleksikon; industrihistorie; bryggeriarkiv; lokalhistoriske foto |

## Anbefalt neste batch

Anbefalt Stories batch 4 bør være **20–30 stories** og bør primært ta utgangspunkt i shortlisten over. For best balanse anbefales:

1. **Første del: Oslo historie/by/politikk** — `middelalder_oslo`, `villa_grande`, `prinds_christian_augusts_minde`, `galgeberg`, `christiania_torv`, `karl_johan`, `bjorvika`, `oslo_s`, `slottsplassen`, `tinghuset`. Dette gir synlige byspor, konflikt, institusjoner og transformasjon.
2. **Andre del: kultur, sport, media og vitenskap** — `nrk_huset_marienlyst`, `hartvig_nissens_skole_skam`, `blaa`, `ekebergsletta`, `botanisk_hage`, `observatoriet`, `universitetets_gamle_kjemi`, `nobelinstituttet`. Dette løfter kategorier som i dag har lav eller null story-dekning.
3. **Tredje del: Lisboa som tydelig internasjonal rute** — `lisbon_largo_do_carmo`, `lisbon_convento_do_carmo`, `lisbon_castelo_de_sao_jorge`, `lisbon_torre_de_belem`, `lisbon_praca_do_comercio`, `lisbon_ponte_25_de_abril`. Disse bør bare tas inn dersom Lisboa-stories ønskes i batch 4; ellers kan de stå som egen batch.

Før skriving bør hvert kandidatsted få en kort research-note med minst to uavhengige kilder eller én primær-/institusjonskilde pluss én uavhengig sekundærkilde. Rapporten foreslår ikke nye story-tekster og gjør ingen dataendringer.
