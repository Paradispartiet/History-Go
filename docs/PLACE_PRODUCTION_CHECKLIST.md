...
DIALEKTLAG — KUN `placeScope: "area"` / N/A. Dialektinnhold kan kun eies av et område-Place med `placeScope: "area"`; enkelt-Places kan ha Språkleksikon, men er ikke dialekteiere. `coordRole` beskriver koordinatgeometri og avgjør ikke dialekteierskap. Når Språkleksikon produseres, skal relevante dialektord og lokale uttrykk vurderes og kildebelegges etter språk-/dialektkontrakten.
