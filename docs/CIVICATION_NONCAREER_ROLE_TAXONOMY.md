...
Career Role World-grunnlaget har fortsatt **85 ferdige karriererolleverdener**. **Supporter**, **Nabolagskjenner**, **Filmklubbmenneske**, **Sofafilosof**, **Historievandrer**, **Gallerivanker**, **Skrivebordspoet** og **Medievaktbikkje** er nå fullførte life-position Role Worlds. Den samlede Role World-indeksen har dermed **93 verdener = 85 career + 8 life_position**.
