...
Civication skal ikke bruke én lineær Badge-stige som både kunnskapsnivå, identitet, jobb, inntekt, berømmelse og sosial status. Det gjør spillet mindre realistisk og mindre morsomt.

Modellen er derfor delt i fire lag:
...
| --- | --- | --- | --- |
| **Historie** | Karriere-tung | Historievandrer, Lokalhistoriker, Arkivrotte, Kulturminnejeger | Behold arkiv/museum/forskning/forvaltning. Skill studentstatus fra jobb. `Masterstuden` må rettes separat uten å bryte canonical mapping. |
| **Religion** | Blandet | Trosstedsvandrer, Livssynsutforsker, Pilegrim, Dialogbygger | Tidlige kunnskaps-/livsposisjoner bør ikke bli jobber. Forskning/formidling/museum/rådgivning må være egne jobbspor. Tro/livssyn er alltid selvvalgt. |
| **Vitenskap & teknologi** | Svært karriere-tung | Folkeforsker, Maker, Stjernekikker, Labnerd, Teknologibygger | Behold akademiske porter. Senere bør tekniske, laboratorie-, IT- og ingeniørspor materialiseres der fagverket støtter det. |
| **Filosofi** | Livs-/status-tung tidlig, uklar jobb sent | Livsgrubler, Sofafilosof, Lesesirkelmenneske, Salongfilosof | Skill lesing/debatt/livsfilosofi fra akademisk jobb. Dokumenterte jobbspor innen etikk, utredning, undervisning og forskning må auditeres før direkte tilbud. |
| **Kunst** | Jobbsporet er sterkt | Gallerivanker, Vernissagegjenger, Gatekunstjeger, Ateliermenneske, Kunstsamler | Behold galleri/museum/kurator/produksjon. Kunstner- og samlerliv bør være liv/levevei, ikke automatisk ansettelse. |
| **Scenekunst** | Blandet, men jobbdrevet | Premieregjenger, Teatergjenganger, Improentusiast, Scenehenger, Festivalveteran | Behold teknikk, produksjon, utøver og ledelse som jobb. Publikumspoeng skal aldri automatisk gi profesjonell utøverstatus. |
| **By & arkitektur** | Svært karriere-tung | Byvandrer, Nabolagskjenner, Byromsnerd, Byflanør, Urbanist | Behold plan/arkitektur/forvaltning. Det nye livssporet gjør at byen kan være en identitet også for folk som jobber med noe helt annet. |
| **Musikk** | Blandet jobb, utøverstatus og berømmelse | Konsertgjenger, Musikknerd, Plategraver, Scenehenger, Festivalveteran | Produksjon/teknikk/utøving kan være jobb. Headliner/Stjerneartist/Popstjerne må også modelleres som status, kontrakter og levevei — ikke bare lønnstittel. |
| **Litteratur & poesi** | Leser-/forfatterliv blandet med jobb | Bokorm, Biblioteksvanker, Bokklubbmenneske, Skrivebordspoet, Småforlagsnerd | Redaksjon/forlag/profesjonell skriving kan være jobb. Bibliotek, bokhandel og litteraturhus bør undersøkes som ekstra jobbspor. Pris/bestseller/kanon/skald er først og fremst status/liv. |
...
3. Litteratur — skill forfatterstatus fra redaksjon/forlag/bibliotek/bokhandel.
4. Medier — skill offentlig profil/makt fra journalistiske stillinger.
