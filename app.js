// ==============================
// History Go – app.js (enkelt og stabilt)
// - Ingen toppmeny
// - Viser kun 2 steder i "nærmest nå"
// - Kart i bakgrunnen (Leaflet) med mild blur (styres i theme.css)
// ==============================
...
const tierFor  = n => (n>=DIPLOMA_THRESHOLDS.gull?'gull' :
                       n>=DIPLOMA_THRESHOLDS.sølv?'sølv' :
                       n>=DIPLOMA_THRESHOLDS.bronse?'bronse' : null);
...
// (valgfritt) auto-lås opp i testmodus hvis innenfor stor radius
...
function init(){
  ...
  // Testmodus – sett posisjon til Oslo sentrum
