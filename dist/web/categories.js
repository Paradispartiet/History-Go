(() => {
  ...
  var win = window;
  var CATEGORY_LIST = [
    { id: "historie", name: "Historie", icon: "\u{1F3DB}\uFE0F", color: "#344B80", scope: "runtime_domain" },
    { id: "religion", name: "Religion", icon: "\u{1F6D0}", color: "#d7b46a", scope: "runtime_domain" },
    { id: "vitenskap", name: "Vitenskap & filosofi", icon: "\u{1F9EA}", color: "#9b59b6", scope: "runtime_domain" },
    { id: "kunst", name: "Kunst & kultur", icon: "\u{1F3A8}", color: "#ffb703", scope: "runtime_domain" },
    { id: "musikk", name: "Musikk & scenekunst", icon: "\u{1F3AD}", color: "#ff66cc", scope: "runtime_domain" },
    { id: "natur", name: "Natur & milj\xF8", icon: "\u{1F33F}", color: "#4caf50", scope: "runtime_domain" },
    { id: "sport", name: "Sport & lek", icon: "\u26BD", color: "#2a9d8f", scope: "runtime_domain" },
    { id: "by", name: "By & arkitektur", icon: "\u{1F3D9}\uFE0F", color: "#e63946", scope: "runtime_domain" },
    { id: "politikk", name: "Politikk & samfunn", icon: "\u{1F3DB}\uFE0F", color: "#c77dff", scope: "runtime_domain" },
    { id: "subkultur", name: "Subkultur", icon: "\u{1F9F7}", color: "#ff66cc", scope: "runtime_domain" },
    { id: "litteratur", name: "Litteratur", icon: "\u{1F4DA}", color: "#f6c800", scope: "runtime_domain" },
    { id: "naeringsliv", name: "N\xE6ringsliv", icon: "\u{1F3ED}", color: "#ff8800", scope: "runtime_domain" },
