...
write("data/places/naeringsliv-production/lilleborg_fabrikker.json", {
  ...
  economicIdentity: { statement: "Lilleborg Fabrikker er et tidligere olje-, såpe- og vaskemiddelindustrianlegg ved Akerselva, senere omformet til boligområde.", anchorType: "former_economic_site", placeObjectDistinction: "Rapporten skiller det historiske fabrikkanlegget fra Lilleborg-brandet, produktobjektene, den videreførte selskapsvirksomheten og hele Lilleborg-strøket.", temporalScope: { start: "1897", end: "1997", precision: "period", rationale: "Aksjeselskapet ble grunnlagt i 1897 og produksjonen på Sandaker ble avsluttet i 1997; eldre virksomhet behandles som forhistorie og senere selskapslinje som etterhistorie." }, sourceIds },
  businessTopics: [
    ...
    { emneId: "em_naering_eierskap_styring", siteSpecificRationale: "Kildal-familien, De-No-Fa, Unilever, Orkla og Solenis viser skiftende kontroll over sted, varemerker og kunnskap.", caseIds: ["case_lilleborg_consumer_goods"] },
  ...
  sources: [
    ...
    { id: "source_lilleborg_snl_kildal", url: urls.snlKildal, sourceLocation: "Faktaboks og hovedavsnittet om Lilleborg", sourceType: "recognized_reference", verifiedAt, temporalCoverage: "historical", provenance: "Fagredigert biografi i Store norske leksikon.", limitations: "Kilden belyser Kildals rolle, ikke hele selskapets historie etter 1882." },
  ...
  economicCases: [{
    ...
    riskAndExternalities: { riskAssessment: { statement: "Virksomheten var avhengig av råvaretilgang, kjemisk og markedsmessig konkurranseevne, varemerker, konsernstrategi og forbrukernes etterspørsel.", sourceIds: ["source_lilleborg_byleksikon", "source_lilleborg_snl_kildal"] }, externalityAssessment: { status: "not_quantified", rationale: "Kildene dokumenterer industri ved Akerselva, men gir ikke et sammenlignbart stedsspesifikt grunnlag for å tallfeste utslipp, lukt, støy, helse eller andre eksternaliteter." } },
