...
const qrows=[
 ...
 ["Hva er viktig å holde separat fra selve parkidentiteten?","det dokumenterte rus- og gatemiljøet som sosialt lag",["det dokumenterte rus- og gatemiljøet som sosialt lag","Akerselva som fysisk grense","parkens gressplen"],"Sosiale miljøer kan overlappe geografisk uten å være identiske med parken.","em_by_parker_som_sosial_infrastruktur",["social"],"fact"],
...
const questions=qrows.map((r,i)=>{
  ...
  const storedAnswerIndex=i%3;const options=[...r[2]];const correct=options.shift();options.splice(storedAnswerIndex,0,correct);const q={id:"vaterlandsparken_quiz_"+String(n).padStart(2,"0"),quiz_id:"by_vaterlandsparken_set_"+setNo+"_q"+((i%7)+1),categoryId,placeId,targetId:placeId,question_scope:"place",question:r[0],options,answer:r[1],answerIndex:storedAnswerIndex,knowledge:r[3],difficulty:setNo,question_type:r[6],question_layer:i<14?"normal_opening":i<21?"bridge":"final",emne_id:r[4],source:r[5],source_origin:"external",claim_basis:r[3],claim_id:"claim_vaterlandsparken_quiz_"+String(n).padStart(2,"0"),primary_knowledge_unit_id:"ku_by_vaterlandsparken_"+String(n).padStart(2,"0"),knowledge_unit_ids:["ku_by_vaterlandsparken_"+String(n).padStart(2,"0")],knowledge_contract_version:1,knowledge_link_status:"linked",concept_ids:[],term_ids:[]};
