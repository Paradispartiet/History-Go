...
const brief = {
  ...
  selected_curriculum: { module_ids: ["kur_by_01_byrom_akser_knutepunkt", "kur_by_04_historiske_lag_og_transformasjon", "kur_by_06_makt_symboler_og_representasjon"], emne_ids: ["em_by_offentlige_rom_motesteder", "em_by_historiske_lag_i_hverdagsrom", "em_by_bygningstyper_og_typologier", "em_by_symbolsk_makt_og_representasjon", "em_by_materialitet_og_sanseerfaring"], topic_hook_ids: ["byliv_aapne_rom", "his_spor_gatebilde", "ark_bygningstyper", "ark_materialbruk"], method_ids: ["met_feltobservasjon", "met_for_etter", "met_gaanalyse"], thinker_ids: ["william_h_whyte", "pierre_nora", "aldo_rossi", "christian_norberg_schulz"], works: ["The Social Life of Small Urban Spaces", "Les Lieux de Mémoire", "The Architecture of the City", "Genius Loci"] },
  claims: claimsBrief,
