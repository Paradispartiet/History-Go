...
allQuestions.forEach((question, index) => {
  ...
  const primaryKnowledgeUnitId = `ku_naeringsliv_schous_bryggeri_${String(number).padStart(2, "0")}`;
...
write("data/places/historie-production/schous_bryggeri.json", {
  schemaVersion: "historie_place_production_v1", validatorVersion: "1.0.0", placeId: "schous_bryggeri", placeFile, status: "ready",
  historicalIdentity: {
    statement: "Schous Bryggeri var en bryggerivirksomhet fra 1821 til 1981, med hovedanlegg på Schousløkken fra 1873 og et stående, senere ombrukt industrimiljø i Trondheimsveien 2.",
    placeRelationType: "institution_site",
    placeRelationStatement: "Place-ID-en representerer bryggerivirksomheten sammen med det historiske produksjonsanlegget på Schousløkken, ikke Schous plass, Schouskvartalet som helhet, Riksscenen eller dagens selvstendige leietakere.",
    temporalScope: { start: "1821", end: "2026", precision: "period", rationale: "Perioden dekker bryggeriets offisielle grunnleggelse, driften på Schousløkken, nedleggelsen i 1981 og den kildekontrollerte ombruken av bygningsmiljøet." },
    sourceIds: ["source_snl_schous_historie", "source_byleksikon_schous_historie", "source_klp_schous_historie"]
  },
  historyTopics: [{
    ...
    caseIds: ["case_schous_industrialisering_og_ombruk"]
  }],
  sources: [
    { id: "source_snl_schous_historie", url: urls.snl, sourceLocation: "Faktaboks, kronologi og hovedtekst om grunnlegging, bayerøl, flytting, sammenslutning og nedleggelse", sourceType: "reputable_secondary", verifiedAt, temporalCoverage: "mixed", provenance: "Store norske leksikons redaksjonelt kontrollerte artikkel om Schous Bryggeri, med navngitt forfatter og revisjonsdato.", limitations: "Artikkelen sammenfatter virksomhetshistorien, men gir ikke et komplett bedriftsarkiv, arbeidslivshistorie eller regnskapsmateriale." },
    { id: "source_byleksikon_schous_historie", url: urls.byleksikon, sourceLocation: "Historikken og bygningsbeskrivelsen for bryggerianlegget i Trondheimsveien 2", sourceType: "museum_or_heritage", verifiedAt, temporalCoverage: "mixed", provenance: "Oslo byleksikons stedsspesifikke oppslagsartikkel dokumenterer anleggets bygninger, arkitekter og historiske funksjoner.", limitations: "Oppslagsformatet komprimerer selskaps- og arbeidslivshistorien, og enkelte eldre årstall må leses sammen med nyere SNL." },
    { id: "source_byleksikon_kvartalet_historie", url: urls.quarter, sourceLocation: "Avsnittene om ombygginger, bygningsnavn og kulturfunksjoner etter nedleggelsen", sourceType: "reputable_secondary", verifiedAt, temporalCoverage: "mixed", provenance: "Oslo byleksikons artikkel om Schouskvartalet dokumenterer hovedtrekk i bygningsmiljøets ombruk etter 1981.", limitations: "Artikkelen er ikke en løpende eller fullstendig oversikt over leietakere, eiendomsforvaltning eller alle bygningsinngrep." },
    { id: "source_klp_schous_historie", url: urls.klp, sourceLocation: "Eiendomspresentasjonen for dagens Schouskvartal, kontor- og næringsbruk", sourceType: "primary", verifiedAt, temporalCoverage: "current", provenance: "KLP Eiendom publiserer som gårdeier aktuell informasjon om eiendommen, arealene og nåværende næringsbruk.", limitations: "Kilden har kommersielt formål og brukes bare til fersk nåstatus, ikke som uavhengig dokumentasjon av historiske årsaker eller virkninger." }
  ],
  caseRealizations: [{
    id: "case_schous_industrialisering_og_ombruk",
    claim: "Schous-anlegget utviklet seg fra familieeid bryggerivirksomhet til et sammensatt industrisystem for produksjon, lagring og distribusjon, før nedleggelsen i 1981 og senere ombruk endret stedets funksjon uten å utslette alle materielle spor.",
    temporalSequence: {
      ...
      startPoint: "Jørgen Young overtok bryggerivirksomheten i 1821, som ble Schous Bryggeris offisielle grunnleggingsår.",
      endPoint: "Bryggeridriften er avsluttet, mens bevarte produksjonsbygg brukes til kontor, undervisning, kultur og servering i dagens Schouskvartal.",
      breaks: ["Christian Julius Schous overtakelse i 1837 ga virksomheten nytt navn og ny ledelse.", "Flyttingen til Schousløkken i 1873 samlet bryggingen i et nytt og senere utvidet industrianlegg.", "Sammenslutningen med Frydenlund i 1962 endret selskapsstrukturen.", "Nedleggelsen i 1981 avsluttet bryggeriproduksjonen og åpnet for ombygging og nye funksjoner."],
      continuities: ["Schous-navnet er fortsatt synlig i bygningsmiljøet og områdets stedsnavn.", "Flere produksjonsbygg og funksjonsnavn er bevart selv om bruken er endret.", "Anleggets plassering ved Trondheimsveien og Nybrua gjør den historiske forbindelsen mellom produksjon og bylogistikk lesbar."],
      sourceIds: ["source_snl_schous_historie", "source_byleksikon_schous_historie", "source_byleksikon_kvartalet_historie", "source_klp_schous_historie"]
    },
    actors: [
      { name: "Bryggeriets eiere og ledelse", roleOrInterest: "Utviklet virksomheten, investerte i produksjonsanlegg og teknologi og organiserte senere selskapsmessig konsolidering.", powerPosition: "Kontrollerte kapital, produksjonsmidler, varemerke og strategiske beslutninger fram til bryggeriets innlemmelse i større selskapsstrukturer.", sourceIds: ["source_snl_schous_historie", "source_byleksikon_schous_historie"] },
      { name: "Bryggeriarbeidere, fagfolk og transportører", roleOrInterest: "Utførte brygging, kjøling, lagring, tapping, vedlikehold og varetransport i det sammenhengende produksjonssystemet.", powerPosition: "Arbeidet og fagkunnskapen var nødvendig for driften, men de åpne kildene gir ikke tilstrekkelig grunnlag for å beskrive lønn, organisering eller medbestemmelse.", sourceIds: ["source_snl_schous_historie", "source_byleksikon_schous_historie"] },
      { name: "Gårdeier og dagens brukere", roleOrInterest: "Forvalter og bruker det tidligere produksjonsmiljøet til næring, undervisning, kultur og servering.", powerPosition: "Gårdeier kontrollerer utleie og fysiske tiltak, mens selvstendige brukere former aktivitetene innenfor sine lokaler og offentlige rammer.", sourceIds: ["source_byleksikon_kvartalet_historie", "source_klp_schous_historie"] }
    ],
    conflictOrNegotiation: { statement: "Stedets ombruk forhandler mellom vern og lesbarhet av industrimiljøet, eiendomsdrift, bygningsmessig oppgradering og nye kultur- og næringsfunksjoner.", sourceIds: ["source_byleksikon_kvartalet_historie", "source_klp_schous_historie"] },
    sourceComparison: {
      sourceIds: ["source_snl_schous_historie", "source_byleksikon_schous_historie", "source_klp_schous_historie"],
    ...
    comparativeScale: {
      localFinding: "Schous viser hvordan produksjon, kjøling, lagring, tapping og distribusjon ble bygget sammen i et ekspanderende industrianlegg ved en sentral bytransportåre.",
      ...
      scale: "european", sourceIds: ["source_snl_schous_historie", "source_byleksikon_schous_historie", "source_byleksikon_kvartalet_historie"]
    },
    causationAndUncertainty: {
      causalAssessment: "Teknologiske investeringer og flyttingen til Schousløkken bidro til industriell vekst, mens konsolideringen og nedleggelsen inngikk i en større omstilling; kildene isolerer ikke én faktor som tilstrekkelig årsak til utviklingen.",
  ...
  presentTrace: {
    ...
    originalSiteRelationship: "Markøren peker til bryggerianlegget på Schousløkken i Trondheimsveien 2; dagens bygg står på produksjonsstedet fra 1873, men kvartalet rommer også nyere og selvstendige funksjoner.",
    sourceIds: ["source_byleksikon_schous_historie", "source_byleksikon_kvartalet_historie", "source_klp_schous_historie"]
  },
  ...
  gates: {
    ...
    B: { status: "PASS", evidenceRefs: ["historyTopics", "caseRealizations.case_schous_industrialisering_og_ombruk"] },
    C: { status: "PASS", evidenceRefs: ["caseRealizations.case_schous_industrialisering_og_ombruk.temporalSequence"] },
    D: { status: "PASS", evidenceRefs: ["caseRealizations.case_schous_industrialisering_og_ombruk.actors", "caseRealizations.case_schous_industrialisering_og_ombruk.conflictOrNegotiation"] },
    E: { status: "PASS", evidenceRefs: ["sources", "caseRealizations.case_schous_industrialisering_og_ombruk.sourceComparison"] },
    F: { status: "PASS", evidenceRefs: ["caseRealizations.case_schous_industrialisering_og_ombruk.comparativeScale", "caseRealizations.case_schous_industrialisering_og_ombruk.causationAndUncertainty"] },
    G: { status: "PASS", evidenceRefs: ["quizOpening"] },
    H: { status: "PASS", evidenceRefs: ["chronologyStories", "data/leksikon/places/oslo/naeringsliv/leksikon_schous_bryggeri.json#chronology"] }
  },
  review: { reviewer: "Schous Bryggeri phase 8–24 Historie review", reviewedAt: verifiedAt, notes: "Virksomhet, varemerke, anlegg, kvartal og dagens brukere er avgrenset. Kronologi, materielle spor, aktører, kildetyper, quizåpning og Story er kontrollert; årsaker, arbeidsvilkår og økonomiske virkninger hevdes ikke utover kildenes dekning." }
});
