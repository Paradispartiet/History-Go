...
const urls = {
  ...
  kulturminnesok: "https://www.kulturminnesok.no/"
};
...
const businessSourceIds = ["source_hjula_snl", "source_hjula_byleksikon", "source_halvor_schou_nbl", "source_hjula_kulturminnesok"];
...
write("data/places/naeringsliv-production/ovre_foss.json", {
  ...
  sources: [
    ...
    { id: "source_hjula_kulturminnesok", url: urls.kulturminnesok, sourceLocation: "Riksantikvarens nåværende registerpost for kulturminne 164747, Hjula Væverier", sourceType: "official", verifiedAt, temporalCoverage: "current", provenance: "Riksantikvarens offisielle Kulturminnesøk-register identifiserer Hjula Væverier som eksisterende kulturminneanlegg.", limitations: "Registerposten dokumenterer kulturminneidentiteten og fysisk bestand, men ikke dagens leietakere, produksjonsvolum eller historiske arbeidsvilkår." }
  ],
  economicCases: [{
    ...
    comparisonAndCausality: { comparisonBasis: "SNL belyser produksjon, arbeid og markeder; Oslo byleksikon kontrollerer stedet og bygget; NBL belyser Schous og Myrens' beslutningsforløp; Riksantikvarens Kulturminnesøk kontrollerer dagens offisielle kulturminneidentitet.", causalStatus: "descriptive_only", causalAssessment: "Kildene viser rekkefølgen mellom etablering, teknologi, vekst, markedssjokk, råvaremangel, sammenslåing og nedleggelse, men isolerer ikke én årsak til vekst eller krise.", alternativeExplanations: ["Råvarepriser, teknologi, lønnskostnader, konkurranse, handelspolitikk, kapital og etterspørsel kan alle ha påvirket utviklingen."], uncertainty: "Uten sammenlignbare bedriftsregnskaper og kontrollgrupper kan virkninger ikke tilskrives én faktor.", sourceIds: businessSourceIds }
  }],
  presentOperation: { operationalStatus: "former", statement: "Tekstilproduksjonen ved Hjula sluttet i 1957. Fabrikkbygningen står etter brann og gjenoppføring og brukes til andre formål; Riksantikvarens aktuelle register identifiserer fortsatt anlegget som Hjula Væverier.", originalEconomicRoleRelationship: "Den stedbundne veveridriften er avsluttet; bevarte og gjenoppførte bygg dokumenterer industristedet uten å videreføre den opprinnelige tekstilproduksjonen.", checkedAt: verifiedAt, sourceIds: ["source_hjula_snl", "source_hjula_byleksikon", "source_hjula_kulturminnesok"] },
