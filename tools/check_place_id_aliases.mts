...
const aliases: AliasMap = { sagene_film: 'sagene', kampen_film: 'kampen', psykologirommet_oslo: 'psykologisk_institutt_uio', nrk_marienlyst: 'nrk_huset_marienlyst', jernbanetorget_trafikknutepunkt: 'jernbanetorget' };
