...
import { audit } from '../scripts/audit-juss-rettsvitenskap-contracts-obligations-contract-law-fulltext-v1.mjs';

test('Avtaler/obligasjoner er strict 4/8/32 fulltekst', () => {
  const report = audit();
