...
const stream=read('data/Civication/narratives/leisure/psykologi_monsterjeger.json');
const world=read('data/Civication/roleWorlds/psykologi/psykologi_monsterjeger.json');
const index=read('data/Civication/roleWorlds/index.json');
assert.equal(world.status,'role_world_complete');
assert.deepEqual(world.life_position_ref,{badge_id:'psykologi',id:'monsterjeger',label:'Mønsterjeger'});
...
const row=audit.positions.find(x=>x.key==='psykologi/monsterjeger');
...
console.log('Mønsterjeger Role World gate ok');
