...
const streamPath='data/Civication/narratives/leisure/litteratur_bokklubbmenneske.json';
...
assert.equal(stream.applies_when.any_tags[0],'litteratur:bokklubbmenneske');
...
console.log('Bokklubbmenneske readiness and lifecycle complete ok');
