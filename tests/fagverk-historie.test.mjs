...
test('Historie er materialisert, redaksjonelt complete og auditert', () => {
  ...
  assert.deepEqual(report.summary, {
    ...
    curriculumCoveredPeriods: 9,
    curriculumPartialPeriods: 0,
    curriculumMissingPeriods: 0,
    periodModuleCount: 3,
    periodModuleUnitCount: 21,
    periodModuleSourceCount: 18,
    periodModuleCaseCount: 9,
