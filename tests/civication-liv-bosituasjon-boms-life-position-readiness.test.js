...
assert.equal(audit.summary.classifications.ready, 18);
assert.equal(audit.summary.classifications.needs_authored_depth, 141);
...
console.log('civication Liv bosituasjon Boms readiness + Role World ok: 56/56 / 14 anchors / 103 total / 18 life-position worlds');
