...
assert.ok(place.published_species_batch >= 9);
assert.ok(place.fauna.length >= 191);
assert.ok(place.published_species_count >= 191);
assert.ok(place.remaining_species_level_taxa_count <= 70);
