...
assert.equal(taxonomy.canonical_counts.life_position_role_worlds,137);
assert.equal(taxonomy.canonical_counts.total_role_worlds,222);
assert.equal(policy.noncareer_subject_boundary.life_position_readiness.completed_life_position_role_worlds,137);
