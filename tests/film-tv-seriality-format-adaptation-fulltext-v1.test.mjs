...
test('Serialitet, format og adaptasjon dekker læringsenheten eksakt', () => {
  ...
  assert.ok(['seriality_format_adaptation_full_chapter_complete_next_unit_source_brief', 'film_history_movements_historiography_source_brief_complete_full_chapter_production', 'film_history_movements_historiography_full_chapter_complete_next_unit_source_brief'].includes(report.subject.nextGate));
