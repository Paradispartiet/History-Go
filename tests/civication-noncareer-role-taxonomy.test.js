...
assert.equal(roleWorldIndex.roles.length, 116, 'Role World-indeksen skal ha 85 karriereverdener + trettien life-position worlds');
...
assert.equal(lifePositionWorlds.length, 31, 'trettien canonical life-position worlds skal være materialisert, inkludert Seriesluker');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 116, career_role_worlds: 85, life_position_role_worlds: 31 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 31,
  total_role_worlds: 116,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 31 life-position worlds / layers remain separate');
