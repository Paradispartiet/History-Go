...
assert.equal(roleWorldIndex.roles.length, 191, 'Role World-indeksen skal ha 85 karriereverdener + 106 life-position worlds');
...
assert.equal(lifePositionWorlds.length, 106, '106 canonical life-position worlds skal være materialisert, inkludert Poet, Skald, Skribent, Bidragsyter og Følger');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 191, career_role_worlds: 85, life_position_role_worlds: 106 });
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 106 life-position worlds / layers remain separate');
