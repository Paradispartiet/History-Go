...
assert.equal(roleWorldIndex.roles.length, 148, 'Role World-indeksen skal ha 85 karriereverdener + sekstitre life-position worlds');
...
assert.equal(lifePositionWorlds.length, 63, 'sekstitre canonical life-position worlds skal være materialisert, inkludert Mønsterjeger');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 148, career_role_worlds: 85, life_position_role_worlds: 63 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 63,
  total_role_worlds: 148,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 63 life-position worlds / layers remain separate');
