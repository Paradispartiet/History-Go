...
assert.equal(roleWorldIndex.roles.length, 152, 'Role World-indeksen skal ha 85 karriereverdener + sekstisju life-position worlds');
...
assert.equal(lifePositionWorlds.length, 67, 'sekstisju canonical life-position worlds skal være materialisert, inkludert Vaneeksperimentør');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 152, career_role_worlds: 85, life_position_role_worlds: 67 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 67,
  total_role_worlds: 152,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 67 life-position worlds / layers remain separate');
