...
assert.equal(roleWorldIndex.roles.length, 203, 'Role World-indeksen skal ha 85 karriereverdener + 118 life-position worlds');
...
assert.equal(lifePositionWorlds.length, 118, '118 canonical life-position worlds skal være materialisert, nå også Demokratianalytiker som egen metodeorientert life-position world');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 203, career_role_worlds: 85, life_position_role_worlds: 118 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 118,
  total_role_worlds: 203,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 118 life-position worlds / layers remain separate');
