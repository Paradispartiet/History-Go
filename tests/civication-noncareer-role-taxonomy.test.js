...
assert.equal(roleWorldIndex.roles.length, 89, 'Role World-indeksen skal ha 85 karriereverdener + fire life-position worlds');
...
assert.equal(lifePositionWorlds.length, 4, 'Supporter, Nabolagskjenner, Filmklubbmenneske og Sofafilosof skal være materialisert som life-position worlds');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 89, career_role_worlds: 85, life_position_role_worlds: 4 });
