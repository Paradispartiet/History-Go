...
assert.equal(roleWorldIndex.roles.length, 185, 'Role World-indeksen skal ha 85 karriereverdener + 100 life-position worlds');
...
assert.equal(lifePositionWorlds.length, 100, '100 canonical life-position worlds skal være materialisert, inkludert Litteraturinteressert');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 185, career_role_worlds: 85, life_position_role_worlds: 100 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 100,
  total_role_worlds: 185,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 100 life-position worlds / layers remain separate');
