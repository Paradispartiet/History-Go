...
assert.equal(roleWorldIndex.roles.length, 126, 'Role World-indeksen skal ha 85 karriereverdener + førtien life-position worlds');
...
assert.equal(lifePositionWorlds.length, 41, 'førtien canonical life-position worlds skal være materialisert, inkludert Gatekunstjeger');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 126, career_role_worlds: 85, life_position_role_worlds: 41 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 41,
  total_role_worlds: 126,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 41 life-position worlds / layers remain separate');
