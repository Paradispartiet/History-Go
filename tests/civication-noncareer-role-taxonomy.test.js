...
assert.equal(roleWorldIndex.roles.length, 178, 'Role World-indeksen skal ha 85 karriereverdener + 93 life-position worlds');
...
assert.equal(lifePositionWorlds.length, 93, '93 canonical life-position worlds skal være materialisert, inkludert Gallerist');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 178, career_role_worlds: 85, life_position_role_worlds: 93 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 93,
  total_role_worlds: 178,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 93 life-position worlds / layers remain separate');
