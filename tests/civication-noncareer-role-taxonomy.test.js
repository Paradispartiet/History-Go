...
assert.equal(roleWorldIndex.roles.length, 213, 'Role World-indeksen skal ha 85 karriereverdener + 128 life-position worlds');
...
assert.equal(lifePositionWorlds.length, 128, '128 canonical life-position worlds skal være materialisert, nå også Troslivskjenner som egen employment-independent lived_religion_literacy');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 213, career_role_worlds: 85, life_position_role_worlds: 128 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 128,
  total_role_worlds: 213,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 128 life-position worlds / layers remain separate');
