...
assert.equal(roleWorldIndex.roles.length, 217, 'Role World-indeksen skal ha 85 karriereverdener + 132 life-position worlds');
...
assert.equal(lifePositionWorlds.length, 132, '132 canonical life-position worlds skal være materialisert, nå også Sport Klubbspiller som egen employment-independent club_participation');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 217, career_role_worlds: 85, life_position_role_worlds: 132 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 132,
  total_role_worlds: 217,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 132 life-position worlds / layers remain separate');
