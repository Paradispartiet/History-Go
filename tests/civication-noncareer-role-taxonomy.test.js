...
assert.equal(roleWorldIndex.roles.length, 202, 'Role World-indeksen skal ha 85 karriereverdener + 117 life-position worlds');
...
assert.equal(lifePositionWorlds.length, 117, '117 canonical life-position worlds skal være materialisert, nå også Aktivist som egen employment-independent activism-practice world');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 202, career_role_worlds: 85, life_position_role_worlds: 117 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 117,
  total_role_worlds: 202,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 117 life-position worlds / layers remain separate');
