...
assert.equal(roleWorldIndex.roles.length, 108, 'Role World-indeksen skal ha 85 karriereverdener + tjueto life-position worlds');
...
assert.equal(lifePositionWorlds.length, 22, 'tjueto canonical life-position worlds skal være materialisert, inkludert Byvandrer');
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 22 life-position worlds / layers remain separate');
