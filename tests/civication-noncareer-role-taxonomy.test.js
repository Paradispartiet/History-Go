...
assert.equal(roleWorldIndex.roles.length, 105, 'Role World-indeksen skal ha 85 karriereverdener + tjue life-position worlds');
...
assert.equal(lifePositionWorlds.length, 20, 'tjue canonical life-position worlds skal være materialisert, inkludert Kriminell');
