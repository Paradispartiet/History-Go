...
assert.equal(roleWorldIndex.roles.length, 166, 'Role World-indeksen skal ha 85 karriereverdener + åttien life-position worlds');
...
assert.equal(lifePositionWorlds.length, 81, 'åttien canonical life-position worlds skal være materialisert, inkludert Folkeforsker');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 166, career_role_worlds: 85, life_position_role_worlds: 81 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 81,
  total_role_worlds: 166,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 81 life-position worlds / layers remain separate');
