...
assert.equal(roleWorldIndex.roles.length, 204, 'Role World-indeksen skal ha 85 karriereverdener + 119 life-position worlds');
...
assert.equal(lifePositionWorlds.length, 119, '119 canonical life-position worlds skal være materialisert, nå også Samfunnsengasjert borger som egen civic-engagement world');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 204, career_role_worlds: 85, life_position_role_worlds: 119 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 119,
  total_role_worlds: 204,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 119 life-position worlds / layers remain separate');
