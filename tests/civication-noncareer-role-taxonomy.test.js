...
assert.equal(roleWorldIndex.roles.length, 151, 'Role World-indeksen skal ha 85 karriereverdener + sekstiseks life-position worlds');
...
assert.equal(lifePositionWorlds.length, 66, 'sekstiseks canonical life-position worlds skal være materialisert, inkludert Selvgransker');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 151, career_role_worlds: 85, life_position_role_worlds: 66 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 66,
  total_role_worlds: 151,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 66 life-position worlds / layers remain separate');
