...
assert.equal(roleWorldIndex.roles.length, 164, 'Role World-indeksen skal ha 85 karriereverdener + syttini life-position worlds');
...
assert.equal(lifePositionWorlds.length, 79, 'syttini canonical life-position worlds skal være materialisert, inkludert Læringsutforsker');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 164, career_role_worlds: 85, life_position_role_worlds: 79 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 79,
  total_role_worlds: 164,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 79 life-position worlds / layers remain separate');
