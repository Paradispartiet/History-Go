...
assert.equal(roleWorldIndex.roles.length, 104, 'Role World-indeksen skal ha 85 karriereverdener + atten life-position worlds');
...
assert.equal(lifePositionWorlds.length, 19, 'atten canonical life-position worlds skal være materialisert, inkludert Boms');
