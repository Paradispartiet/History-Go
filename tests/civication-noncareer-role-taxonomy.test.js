...
assert.equal(roleWorldIndex.roles.length, 201, 'Role World-indeksen skal ha 85 karriereverdener + 116 life-position worlds');
...
assert.equal(lifePositionWorlds.length, 116, '116 canonical life-position worlds skal være materialisert, nå også Naturinteressert som egen bred Natur-life-position world');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 201, career_role_worlds: 85, life_position_role_worlds: 116 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 116,
  total_role_worlds: 201,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 116 life-position worlds / layers remain separate');
