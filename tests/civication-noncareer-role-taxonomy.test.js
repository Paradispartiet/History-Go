...
assert.equal(roleWorldIndex.roles.length, 175, 'Role World-indeksen skal ha 85 karriereverdener + 90 life-position worlds');
...
assert.equal(lifePositionWorlds.length, 90, '90 canonical life-position worlds skal være materialisert, inkludert Nysgjerrig');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 175, career_role_worlds: 85, life_position_role_worlds: 90 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 90,
  total_role_worlds: 175,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 90 life-position worlds / layers remain separate');
