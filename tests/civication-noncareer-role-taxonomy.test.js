...
assert.equal(roleWorldIndex.roles.length, 129, 'Role World-indeksen skal ha 85 karriereverdener + førtifire life-position worlds');
...
assert.equal(lifePositionWorlds.length, 44, 'førtifire canonical life-position worlds skal være materialisert, inkludert Bokklubbmenneske');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 129, career_role_worlds: 85, life_position_role_worlds: 44 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 44,
  total_role_worlds: 129,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 44 life-position worlds / layers remain separate');
