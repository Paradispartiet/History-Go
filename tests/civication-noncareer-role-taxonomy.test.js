...
assert.equal(roleWorldIndex.roles.length, 110, 'Role World-indeksen skal ha 85 karriereverdener + tjuefire life-position worlds');
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 25 life-position worlds / layers remain separate');
