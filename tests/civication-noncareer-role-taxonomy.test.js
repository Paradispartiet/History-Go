...
assert.equal(roleWorldIndex.roles.length, 132, 'Role World-indeksen skal ha 85 karriereverdener + førtisju life-position worlds');
...
assert.equal(lifePositionWorlds.length, 47, 'førtisju canonical life-position worlds skal være materialisert, inkludert Kommentarfeltveteran');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 132, career_role_worlds: 85, life_position_role_worlds: 47 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 47,
  total_role_worlds: 132,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 47 life-position worlds / layers remain separate');
