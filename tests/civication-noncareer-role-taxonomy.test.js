...
assert.equal(roleWorldIndex.roles.length, 210, 'Role World-indeksen skal ha 85 karriereverdener + 125 life-position worlds');
...
assert.equal(lifePositionWorlds.length, 125, '125 canonical life-position worlds skal være materialisert, nå også Ritualkjenner som egen employment-independent ritual_literacy');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 210, career_role_worlds: 85, life_position_role_worlds: 125 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 125,
  total_role_worlds: 210,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 125 life-position worlds / layers remain separate');
