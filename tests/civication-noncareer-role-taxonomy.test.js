...
assert.equal(roleWorldIndex.roles.length, 147, 'Role World-indeksen skal ha 85 karriereverdener + sekstito life-position worlds');
...
assert.equal(lifePositionWorlds.length, 62, 'sekstito canonical life-position worlds skal være materialisert, inkludert Organisasjonsmenneske');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 147, career_role_worlds: 85, life_position_role_worlds: 62 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 62,
  total_role_worlds: 147,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 62 life-position worlds / layers remain separate');
