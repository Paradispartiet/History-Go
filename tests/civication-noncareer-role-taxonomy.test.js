...
assert.equal(roleWorldIndex.roles.length, 141, 'Role World-indeksen skal ha 85 karriereverdener + femtiseks life-position worlds');
...
assert.equal(lifePositionWorlds.length, 56, 'femtiseks canonical life-position worlds skal være materialisert, inkludert Fuglekikker');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 141, career_role_worlds: 85, life_position_role_worlds: 56 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 56,
  total_role_worlds: 141,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 56 life-position worlds / layers remain separate');
