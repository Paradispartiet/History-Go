...
assert.equal(roleWorldIndex.roles.length, 140, 'Role World-indeksen skal ha 85 karriereverdener + femtifem life-position worlds');
...
assert.equal(lifePositionWorlds.length, 55, 'femtifem canonical life-position worlds skal være materialisert, inkludert Småsparer');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 140, career_role_worlds: 85, life_position_role_worlds: 55 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 55,
  total_role_worlds: 140,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 55 life-position worlds / layers remain separate');
