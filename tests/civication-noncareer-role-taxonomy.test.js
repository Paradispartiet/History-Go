...
assert.equal(roleWorldIndex.roles.length, 207, 'Role World-indeksen skal ha 85 karriereverdener + 122 life-position worlds');
...
assert.equal(lifePositionWorlds.length, 122, '122 canonical life-position worlds skal være materialisert, nå også Besøkende som egen situasjonsbundet gjesterolle');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 207, career_role_worlds: 85, life_position_role_worlds: 122 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 122,
  total_role_worlds: 207,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 122 life-position worlds / layers remain separate');
