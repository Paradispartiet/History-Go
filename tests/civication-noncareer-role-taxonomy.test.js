...
assert.equal(roleWorldIndex.roles.length, 176, 'Role World-indeksen skal ha 85 karriereverdener + 91 life-position worlds');
...
assert.equal(lifePositionWorlds.length, 91, '91 canonical life-position worlds skal være materialisert, inkludert Samtalepartner');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 176, career_role_worlds: 85, life_position_role_worlds: 91 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 91,
  total_role_worlds: 176,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 91 life-position worlds / layers remain separate');
