...
assert.equal(roleWorldIndex.roles.length, 226, 'Role World-indeksen skal ha 85 karriereverdener + 141 life-position worlds');
...
assert.equal(lifePositionWorlds.length, 141, '141 canonical life-position worlds skal være materialisert, nå også Subkultur Observør som egen employment-independent subculture_status');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 226, career_role_worlds: 85, life_position_role_worlds: 141 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 141,
  total_role_worlds: 226,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 141 life-position worlds / layers remain separate');
