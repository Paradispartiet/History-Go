...
assert.equal(roleWorldIndex.roles.length, 212, 'Role World-indeksen skal ha 85 karriereverdener + 127 life-position worlds');
...
assert.equal(lifePositionWorlds.length, 127, '127 canonical life-position worlds skal være materialisert, nå også Tradisjonskjenner som egen employment-independent tradition_literacy');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 212, career_role_worlds: 85, life_position_role_worlds: 127 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 127,
  total_role_worlds: 212,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 127 life-position worlds / layers remain separate');
