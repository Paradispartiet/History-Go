...
assert.equal(roleWorldIndex.roles.length, 136, 'Role World-indeksen skal ha 85 karriereverdener + femtien life-position worlds');
...
assert.equal(lifePositionWorlds.length, 51, 'femtien canonical life-position worlds skal være materialisert, inkludert Musikknerd');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 136, career_role_worlds: 85, life_position_role_worlds: 51 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 51,
  total_role_worlds: 136,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 51 life-position worlds / layers remain separate');
