...
assert.equal(roleWorldIndex.roles.length, 167, 'Role World-indeksen skal ha 85 karriereverdener + åttito life-position worlds');
...
assert.equal(lifePositionWorlds.length, 82, 'åttito canonical life-position worlds skal være materialisert, inkludert Labnerd');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 167, career_role_worlds: 85, life_position_role_worlds: 82 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 82,
  total_role_worlds: 167,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 82 life-position worlds / layers remain separate');
