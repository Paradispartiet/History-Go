...
assert.equal(roleWorldIndex.roles.length, 158, 'Role World-indeksen skal ha 85 karriereverdener + syttitre life-position worlds');
...
assert.equal(lifePositionWorlds.length, 73, 'syttitre canonical life-position worlds skal være materialisert, inkludert Premieregjenger');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 158, career_role_worlds: 85, life_position_role_worlds: 73 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 73,
  total_role_worlds: 158,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 73 life-position worlds / layers remain separate');
