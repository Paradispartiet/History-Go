...
assert.equal(roleWorldIndex.roles.length, 222, 'Role World-indeksen skal ha 85 karriereverdener + 137 life-position worlds');
...
assert.equal(lifePositionWorlds.length, 137, '137 canonical life-position worlds skal være materialisert, nå også Subkultur Dandy som egen employment-independent alternative_life_status');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 222, career_role_worlds: 85, life_position_role_worlds: 137 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 137,
  total_role_worlds: 222,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 137 life-position worlds / layers remain separate');
