...
assert.equal(roleWorldIndex.roles.length, 180, 'Role World-indeksen skal ha 85 karriereverdener + 95 life-position worlds');
...
assert.equal(lifePositionWorlds.length, 95, '95 canonical life-position worlds skal være materialisert, inkludert Anmelder');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 180, career_role_worlds: 85, life_position_role_worlds: 95 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 95,
  total_role_worlds: 180,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 95 life-position worlds / layers remain separate');
