...
assert.equal(roleWorldIndex.roles.length, 199, 'Role World-indeksen skal ha 85 karriereverdener + 114 life-position worlds');
...
assert.equal(lifePositionWorlds.length, 114, '114 canonical life-position worlds skal være materialisert, nå også Artsobservatør som egen artsfokusert life-position world');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 199, career_role_worlds: 85, life_position_role_worlds: 114 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 114,
  total_role_worlds: 199,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 114 life-position worlds / layers remain separate');
