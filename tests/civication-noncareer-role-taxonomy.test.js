...
assert.equal(roleWorldIndex.roles.length, 172, 'Role World-indeksen skal ha 85 karriereverdener + 87 life-position worlds');
...
assert.equal(lifePositionWorlds.length, 87, '87 canonical life-position worlds skal være materialisert, inkludert Fagfilosof');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 172, career_role_worlds: 85, life_position_role_worlds: 87 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 87,
  total_role_worlds: 172,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 87 life-position worlds / layers remain separate');
