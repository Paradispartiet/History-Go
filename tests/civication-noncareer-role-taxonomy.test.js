...
assert.equal(roleWorldIndex.roles.length, 174, 'Role World-indeksen skal ha 85 karriereverdener + 89 life-position worlds');
...
assert.equal(lifePositionWorlds.length, 89, '89 canonical life-position worlds skal være materialisert, inkludert Logiker');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 174, career_role_worlds: 85, life_position_role_worlds: 89 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 89,
  total_role_worlds: 174,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 89 life-position worlds / layers remain separate');
