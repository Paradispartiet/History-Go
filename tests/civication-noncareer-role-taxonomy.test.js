...
assert.equal(roleWorldIndex.roles.length, 186, 'Role World-indeksen skal ha 85 karriereverdener + 101 life-position worlds');
...
assert.equal(lifePositionWorlds.length, 101, '101 canonical life-position worlds skal være materialisert, inkludert Litteraturkritiker');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 186, career_role_worlds: 85, life_position_role_worlds: 101 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 101,
  total_role_worlds: 186,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 101 life-position worlds / layers remain separate');
