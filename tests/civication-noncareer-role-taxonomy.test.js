...
assert.equal(roleWorldIndex.roles.length, 177, 'Role World-indeksen skal ha 85 karriereverdener + 92 life-position worlds');
...
assert.equal(lifePositionWorlds.length, 92, '92 canonical life-position worlds skal være materialisert, inkludert Spørrer');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 177, career_role_worlds: 85, life_position_role_worlds: 92 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 92,
  total_role_worlds: 177,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 92 life-position worlds / layers remain separate');
