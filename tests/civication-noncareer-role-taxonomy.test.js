...
assert.equal(roleWorldIndex.roles.length, 214, 'Role World-indeksen skal ha 85 karriereverdener + 129 life-position worlds');
...
assert.equal(lifePositionWorlds.length, 129, '129 canonical life-position worlds skal være materialisert, nå også Scenekunst Publikum som egen employment-independent audience_status');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 214, career_role_worlds: 85, life_position_role_worlds: 129 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 129,
  total_role_worlds: 214,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 129 life-position worlds / layers remain separate');
