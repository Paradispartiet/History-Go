...
assert.equal(roleWorldIndex.roles.length, 157, 'Role World-indeksen skal ha 85 karriereverdener + syttito life-position worlds');
...
assert.equal(lifePositionWorlds.length, 72, 'syttito canonical life-position worlds skal være materialisert, inkludert Improentusiast');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 157, career_role_worlds: 85, life_position_role_worlds: 72 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 72,
  total_role_worlds: 157,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 72 life-position worlds / layers remain separate');
