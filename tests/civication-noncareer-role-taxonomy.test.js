...
assert.equal(roleWorldIndex.roles.length, 117, 'Role World-indeksen skal ha 85 karriereverdener + trettito life-position worlds');
...
assert.equal(lifePositionWorlds.length, 32, 'trettito canonical life-position worlds skal være materialisert, inkludert Lesesirkelmenneske');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 117, career_role_worlds: 85, life_position_role_worlds: 32 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 32,
  total_role_worlds: 117,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 32 life-position worlds / layers remain separate');
