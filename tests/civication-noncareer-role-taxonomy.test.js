...
assert.equal(roleWorldIndex.roles.length, 206, 'Role World-indeksen skal ha 85 karriereverdener + 121 life-position worlds');
...
assert.equal(lifePositionWorlds.length, 121, '121 canonical life-position worlds skal være materialisert, nå også Tillitsvalgt som eget representativt mandat');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 206, career_role_worlds: 85, life_position_role_worlds: 121 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 121,
  total_role_worlds: 206,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 121 life-position worlds / layers remain separate');
