...
assert.equal(roleWorldIndex.roles.length, 153, 'Role World-indeksen skal ha 85 karriereverdener + sekstiåtte life-position worlds');
...
assert.equal(lifePositionWorlds.length, 68, 'sekstiåtte canonical life-position worlds skal være materialisert, inkludert Dialogbygger');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 153, career_role_worlds: 85, life_position_role_worlds: 68 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 68,
  total_role_worlds: 153,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 68 life-position worlds / layers remain separate');
