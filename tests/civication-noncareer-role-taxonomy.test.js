...
assert.equal(roleWorldIndex.roles.length, 135, 'Role World-indeksen skal ha 85 karriereverdener + femti life-position worlds');
...
assert.equal(lifePositionWorlds.length, 50, 'femti canonical life-position worlds skal være materialisert, inkludert Konsertgjenger');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 135, career_role_worlds: 85, life_position_role_worlds: 50 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 50,
  total_role_worlds: 135,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 50 life-position worlds / layers remain separate');
