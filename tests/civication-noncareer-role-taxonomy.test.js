...
assert.equal(roleWorldIndex.roles.length, 211, 'Role World-indeksen skal ha 85 karriereverdener + 126 life-position worlds');
...
assert.equal(lifePositionWorlds.length, 126, '126 canonical life-position worlds skal være materialisert, nå også Symboltolker som egen employment-independent symbol_interpretation_practice');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 211, career_role_worlds: 85, life_position_role_worlds: 126 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 126,
  total_role_worlds: 211,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 126 life-position worlds / layers remain separate');
