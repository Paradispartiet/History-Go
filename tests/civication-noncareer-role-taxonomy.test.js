...
assert.equal(roleWorldIndex.roles.length, 168, 'Role World-indeksen skal ha 85 karriereverdener + åttitre life-position worlds');
...
assert.equal(lifePositionWorlds.length, 83, 'åttitre canonical life-position worlds skal være materialisert, inkludert Stjernekikker');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 168, career_role_worlds: 85, life_position_role_worlds: 83 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 83,
  total_role_worlds: 168,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 83 life-position worlds / layers remain separate');
