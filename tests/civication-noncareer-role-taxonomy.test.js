...
assert.equal(roleWorldIndex.roles.length, 173, 'Role World-indeksen skal ha 85 karriereverdener + 88 life-position worlds');
...
assert.equal(lifePositionWorlds.length, 88, '88 canonical life-position worlds skal være materialisert, inkludert Filosofisk veileder');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 173, career_role_worlds: 85, life_position_role_worlds: 88 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 88,
  total_role_worlds: 173,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 88 life-position worlds / layers remain separate');
