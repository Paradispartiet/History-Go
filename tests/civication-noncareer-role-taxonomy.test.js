...
assert.equal(roleWorldIndex.roles.length, 159, 'Role World-indeksen skal ha 85 karriereverdener + syttifire life-position worlds');
...
assert.equal(lifePositionWorlds.length, 74, 'syttifire canonical life-position worlds skal være materialisert, inkludert Teatergjenganger');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 159, career_role_worlds: 85, life_position_role_worlds: 74 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 74,
  total_role_worlds: 159,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 74 life-position worlds / layers remain separate');
