...
assert.equal(roleWorldIndex.roles.length, 165, 'Role World-indeksen skal ha 85 karriereverdener + åtti life-position worlds');
...
assert.equal(lifePositionWorlds.length, 80, 'åtti canonical life-position worlds skal være materialisert, inkludert Utdanningskritiker');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 165, career_role_worlds: 85, life_position_role_worlds: 80 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 80,
  total_role_worlds: 165,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 80 life-position worlds / layers remain separate');
