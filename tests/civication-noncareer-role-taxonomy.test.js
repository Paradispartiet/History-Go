...
assert.equal(roleWorldIndex.roles.length, 205, 'Role World-indeksen skal ha 85 karriereverdener + 120 life-position worlds');
...
assert.equal(lifePositionWorlds.length, 120, '120 canonical life-position worlds skal være materialisert, nå også Statsvitenskapelig ekspert som egen method-bounded political-science expertise world');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 205, career_role_worlds: 85, life_position_role_worlds: 120 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 120,
  total_role_worlds: 205,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 120 life-position worlds / layers remain separate');
