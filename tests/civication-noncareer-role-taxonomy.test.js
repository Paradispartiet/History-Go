...
assert.equal(roleWorldIndex.roles.length, 195, 'Role World-indeksen skal ha 85 karriereverdener + 110 life-position worlds');
...
assert.equal(lifePositionWorlds.length, 110, '110 canonical life-position worlds skal være materialisert, inkludert Poet, Skald, Skribent, Bidragsyter, Følger, Frilansjournalist, Kommentator (felt), Media/Leser og Plateartist');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 195, career_role_worlds: 85, life_position_role_worlds: 110 });
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 110 life-position worlds / layers remain separate');
