...
assert.equal(roleWorldIndex.roles.length, 134, 'Role World-indeksen skal ha 85 karriereverdener + førtini life-position worlds');
...
assert.equal(lifePositionWorlds.length, 49, 'førtini canonical life-position worlds skal være materialisert, inkludert Podkastsluker');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 134, career_role_worlds: 85, life_position_role_worlds: 49 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 49,
  total_role_worlds: 134,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 49 life-position worlds / layers remain separate');
