...
assert.equal(roleWorldIndex.roles.length, 139, 'Role World-indeksen skal ha 85 karriereverdener + femtifire life-position worlds');
...
assert.equal(lifePositionWorlds.length, 54, 'femtifire canonical life-position worlds skal være materialisert, inkludert Pendler');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 139, career_role_worlds: 85, life_position_role_worlds: 54 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 54,
  total_role_worlds: 139,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 54 life-position worlds / layers remain separate');
