...
assert.equal(roleWorldIndex.roles.length, 225, 'Role World-indeksen skal ha 85 karriereverdener + 140 life-position worlds');
...
assert.equal(lifePositionWorlds.length, 140, '140 canonical life-position worlds skal være materialisert, nå også Subkultur Hakkekylling som egen employment-independent subculture_status');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 225, career_role_worlds: 85, life_position_role_worlds: 140 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 140,
  total_role_worlds: 225,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 140 life-position worlds / layers remain separate');
