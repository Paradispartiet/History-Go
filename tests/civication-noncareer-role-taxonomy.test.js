...
assert.equal(roleWorldIndex.roles.length, 196, 'Role World-indeksen skal ha 85 karriereverdener + 111 life-position worlds');
...
assert.equal(lifePositionWorlds.length, 111, '111 canonical life-position worlds skal være materialisert, inkludert Poet, Skald, Skribent, Bidragsyter, Følger, Frilansjournalist, Kommentator (felt), Media/Leser, Plateartist og Publikum / deltaker');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 196, career_role_worlds: 85, life_position_role_worlds: 111 });
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 111 life-position worlds / layers remain separate');
