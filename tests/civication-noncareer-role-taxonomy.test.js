...
assert.equal(roleWorldIndex.roles.length, 216, 'Role World-indeksen skal ha 85 karriereverdener + 131 life-position worlds');
...
assert.equal(lifePositionWorlds.length, 131, '131 canonical life-position worlds skal være materialisert, nå også Sport Aktiv utøver som egen employment-independent participation_practice');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 216, career_role_worlds: 85, life_position_role_worlds: 131 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 131,
  total_role_worlds: 216,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 131 life-position worlds / layers remain separate');
