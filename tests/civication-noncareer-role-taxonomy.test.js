...
assert.equal(roleWorldIndex.roles.length, 220, 'Role World-indeksen skal ha 85 karriereverdener + 135 life-position worlds');
...
assert.equal(lifePositionWorlds.length, 135, '135 canonical life-position worlds skal være materialisert, nå også Sport Profesjonell utøver som egen employment-independent professional_practice');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 220, career_role_worlds: 85, life_position_role_worlds: 135 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 135,
  total_role_worlds: 220,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 135 life-position worlds / layers remain separate');
