...
assert.equal(roleWorldIndex.roles.length, 215, 'Role World-indeksen skal ha 85 karriereverdener + 130 life-position worlds');
...
assert.equal(lifePositionWorlds.length, 130, '130 canonical life-position worlds skal være materialisert, nå også Scenekunst Utøver som egen employment-independent artistic_performance_practice');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 215, career_role_worlds: 85, life_position_role_worlds: 130 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 130,
  total_role_worlds: 215,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 130 life-position worlds / layers remain separate');
