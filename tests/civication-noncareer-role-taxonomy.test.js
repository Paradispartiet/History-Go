...
assert.equal(roleWorldIndex.roles.length, 184, 'Role World-indeksen skal ha 85 karriereverdener + 99 life-position worlds');
...
assert.equal(lifePositionWorlds.length, 99, '99 canonical life-position worlds skal være materialisert, inkludert Leser');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 184, career_role_worlds: 85, life_position_role_worlds: 99 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 99,
  total_role_worlds: 184,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 99 life-position worlds / layers remain separate');
