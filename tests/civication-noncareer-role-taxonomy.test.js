...
assert.equal(roleWorldIndex.roles.length, 87, 'Role World-indeksen skal ha 85 karriereverdener + to life-position worlds');
...
assert.equal(lifePositionWorlds.length, 2, 'Supporter og Nabolagskjenner skal være materialisert som life-position worlds');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 87, career_role_worlds: 85, life_position_role_worlds: 2 });
