...
assert.equal(roleWorldIndex.roles.length, 160, 'Role World-indeksen skal ha 85 karriereverdener + syttifem life-position worlds');
...
assert.equal(lifePositionWorlds.length, 75, 'syttifem canonical life-position worlds skal være materialisert, inkludert Søndagsutøver');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 160, career_role_worlds: 85, life_position_role_worlds: 75 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 75,
  total_role_worlds: 160,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 75 life-position worlds / layers remain separate');
