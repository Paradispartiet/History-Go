...
assert.equal(roleWorldIndex.roles.length, 92, 'Role World-indeksen skal ha 85 karriereverdener + seks life-position worlds');
...
assert.equal(lifePositionWorlds.length, 7, 'Supporter, Nabolagskjenner, Filmklubbmenneske, Sofafilosof, Historievandrer og Gallerivanker skal være materialisert som life-position worlds');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 92, career_role_worlds: 85, life_position_role_worlds: 7 });
