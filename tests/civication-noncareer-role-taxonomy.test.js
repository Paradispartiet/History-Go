...
assert.equal(roleWorldIndex.roles.length, 236, 'Role World-indeksen skal ha 85 karriereverdener + 151 life-position worlds');
...
assert.equal(lifePositionWorlds.length, 151, '151 canonical life-position worlds skal være materialisert, nå også Næringsliv Bedriftseier som egen employment-independent business ownership');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 236, career_role_worlds: 85, life_position_role_worlds: 151 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 151,
  total_role_worlds: 236,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 151 life-position worlds / layers remain separate');
