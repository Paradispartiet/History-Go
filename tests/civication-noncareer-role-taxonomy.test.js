...
assert.equal(roleWorldIndex.roles.length, 95, 'Role World-indeksen skal ha 85 karriereverdener + ti life-position worlds');
...
assert.equal(lifePositionWorlds.length, 10, 'ti canonical life-position worlds skal være materialisert, inkludert Musikk/Scenehenger');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 95, career_role_worlds: 85, life_position_role_worlds: 10 });
