...
assert.equal(roleWorldIndex.roles.length, 161, 'Role World-indeksen skal ha 85 karriereverdener + syttiseks life-position worlds');
...
assert.equal(lifePositionWorlds.length, 76, 'syttiseks canonical life-position worlds skal være materialisert, inkludert Tribunesliter');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 161, career_role_worlds: 85, life_position_role_worlds: 76 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 76,
  total_role_worlds: 161,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 76 life-position worlds / layers remain separate');
