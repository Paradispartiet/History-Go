...
assert.equal(roleWorldIndex.roles.length, 133, 'Role World-indeksen skal ha 85 karriereverdener + førtåtte life-position worlds');
...
assert.equal(lifePositionWorlds.length, 48, 'førtåtte canonical life-position worlds skal være materialisert, inkludert Nyhetsjunkie');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 133, career_role_worlds: 85, life_position_role_worlds: 48 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 48,
  total_role_worlds: 133,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 48 life-position worlds / layers remain separate');
