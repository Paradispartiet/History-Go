...
assert.equal(roleWorldIndex.roles.length, 221, 'Role World-indeksen skal ha 85 karriereverdener + 136 life-position worlds');
...
assert.equal(lifePositionWorlds.length, 136, '136 canonical life-position worlds skal være materialisert, nå også Subkultur Crew som egen employment-independent subculture_status');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 221, career_role_worlds: 85, life_position_role_worlds: 136 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 136,
  total_role_worlds: 221,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 136 life-position worlds / layers remain separate');
