...
assert.equal(roleWorldIndex.roles.length, 200, 'Role World-indeksen skal ha 85 karriereverdener + 115 life-position worlds');
...
assert.equal(lifePositionWorlds.length, 115, '115 canonical life-position worlds skal være materialisert, nå også Feltobservatør som egen feltpraksis-world');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 200, career_role_worlds: 85, life_position_role_worlds: 115 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 115,
  total_role_worlds: 200,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 115 life-position worlds / layers remain separate');
