...
assert.equal(roleWorldIndex.roles.length, 197, 'Role World-indeksen skal ha 85 karriereverdener + 112 life-position worlds');
...
assert.equal(lifePositionWorlds.length, 112, '112 canonical life-position worlds skal være materialisert, inkludert Poet, Skald, Skribent, Bidragsyter, Følger, Frilansjournalist, Kommentator (felt), Media/Leser, Plateartist, Publikum / deltaker og Solist');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 197, career_role_worlds: 85, life_position_role_worlds: 112 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 112,
  total_role_worlds: 197,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 112 life-position worlds / layers remain separate');
