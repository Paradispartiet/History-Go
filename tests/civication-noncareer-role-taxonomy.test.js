...
assert.equal(roleWorldIndex.roles.length, 198, 'Role World-indeksen skal ha 85 karriereverdener + 113 life-position worlds');
...
assert.equal(lifePositionWorlds.length, 113, '113 canonical life-position worlds skal være materialisert, inkludert Poet, Skald, Skribent, Bidragsyter, Følger, Frilansjournalist, Kommentator (felt), Media/Leser, Plateartist, Publikum / deltaker, Solist og Utøvende musiker');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 198, career_role_worlds: 85, life_position_role_worlds: 113 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 113,
  total_role_worlds: 198,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 113 life-position worlds / layers remain separate');
