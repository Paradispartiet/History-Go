...
assert.equal(roleWorldIndex.roles.length, 194, 'Role World-indeksen skal ha 85 karriereverdener + 109 life-position worlds');
...
assert.equal(lifePositionWorlds.length, 109, '109 canonical life-position worlds skal være materialisert, inkludert Poet, Skald, Skribent, Bidragsyter, Følger, Frilansjournalist, Kommentator (felt) og Media/Leser');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 194, career_role_worlds: 85, life_position_role_worlds: 109 });
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 109 life-position worlds / layers remain separate');
