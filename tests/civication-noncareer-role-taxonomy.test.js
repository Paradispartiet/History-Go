...
assert.equal(roleWorldIndex.roles.length, 227, 'Role World-indeksen skal ha 85 karriereverdener + 142 life-position worlds');
...
assert.equal(lifePositionWorlds.length, 142, '142 canonical life-position worlds skal være materialisert, nå også Kunstsamler som egen livelihood-sensitive ownership identity');
...
assert.deepEqual(roleWorldIndex.summary, { role_worlds_total: 227, career_role_worlds: 85, life_position_role_worlds: 142 });
...
const expectedCounts = {
  ...
  life_position_role_worlds: 142,
  total_role_worlds: 227,
...
console.log('civication non-career role taxonomy ok: 199 selectable life positions / 85 career Role Worlds + 142 life-position worlds / layers remain separate');
