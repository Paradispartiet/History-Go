...
const streamPath='data/Civication/narratives/leisure/kunst_gatekunstjeger.json';
...
assert.equal(stream.applies_when.any_tags[0],'kunst:gatekunstjeger');
...
console.log('Gatekunstjeger readiness and lifecycle complete ok');
