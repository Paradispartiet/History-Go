...
assert.equal(index.roles.filter((entry) => entry.subject_type === 'life_position').length, 5);
assert.equal(index.summary.role_worlds_total, 90);
assert.equal(index.summary.career_role_worlds, 85);
assert.equal(index.summary.life_position_role_worlds, 5);
