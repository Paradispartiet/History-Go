...
const streamPath='data/Civication/narratives/leisure/historie_lokalhistoriker.json';
...
assert.equal(stream.applies_when.any_tags[0],'historie:lokalhistoriker');
...
console.log('Lokalhistoriker readiness and lifecycle complete ok');
