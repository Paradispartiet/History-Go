...
const readingPath = 'data/lesespor/oslo/lesespor_oslo_birkelunden.json';
...
assert.equal(riksantikvaren.source_quality, 'official');
...
const manifestEntry = 'oslo/lesespor_oslo_birkelunden.json';
