...
assert.equal(audit.summary.classifications.ready,audit.positions.filter((item)=>item.classification==='ready').length);assert.equal(audit.summary.classifications.needs_authored_depth,audit.positions.filter((item)=>item.classification==='needs_authored_depth').length);assert.equal(audit.summary.classifications.not_a_standalone_world,audit.positions.filter((item)=>item.classification==='not_a_standalone_world').length);
