...
test('kapittel, brief og registry bruker samme canonicale emne-ID-er', () => {
  ...
  const postReauditGate = nextGate === 'canonical_chapter_reaudit_complete_learning_order_plan'
    ...
    || /(?:source_brief_complete_full_chapter_production|full_chapter_complete_next_unit_source_brief|full_chapter_complete_completion_audit|maintenance_source_refresh_and_place_case_expansion)$/.test(nextGate);
