...
assert(sheet.textContent.includes('Basert på kunnskap'), 'canonical sheet explains knowledge-based matching');
assertNoForbiddenUi(sheet, 'canonical Spotmeeting sheet');

click(appWindow, '[data-hg-spotmeeting-action="quiz"]', 'Canonical sheet → Ta quiz sammen');
