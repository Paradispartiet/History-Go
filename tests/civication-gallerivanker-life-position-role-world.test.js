...
assert.equal(taxonomy.role_world_rollout_boundary.completed_life_position_role_worlds.length,taxonomy.canonical_counts.life_position_role_worlds);assert.ok(taxonomy.role_world_rollout_boundary.completed_life_position_role_worlds.includes(world.life_position_ref.badge_id+'/'+world.life_position_ref.id));
