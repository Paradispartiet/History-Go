...
const FILM_TV_PRODUCTION_GATE = /(?:source_brief_complete_full_chapter_production|full_chapter_complete_next_unit_source_brief|cultural_heritage_canon_stars_memory_full_chapter_complete_completion_audit)$/;
