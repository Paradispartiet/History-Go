...
test('Erstatning/tingsrett bevarer 13/8/32 source-first-grunnlaget etter materialisering', () => {
  const report = audit();
  ...
  assert.equal(report.gates.source_first_brief_preserved_after_materialization, true);
