...
const streamPath='data/Civication/narratives/leisure/kunst_ateliermenneske.json';
...
assert.equal(stream.applies_when.any_tags[0],'kunst:ateliermenneske');
...
console.log('Ateliermenneske readiness and lifecycle complete ok');
