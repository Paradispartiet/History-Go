...
console.error('GALLERIST_ROW_DIFF='+JSON.stringify(diffs));
console.error('GALLERIST_REPORT_CHANGED='+String(beforeReport!==afterReport));
throw new Error('intentional Gallerist row-level generator diagnostic; do not merge this head');
