...
test('Film & TV variable canon remains materialized after later chapter production', () => {
  ...
  const postMigrationGate = status.nextGate === 'canonical_inventory_migrated_existing_chapter_reaudit'
    ...
    || /(?:source_brief_complete_full_chapter_production|full_chapter_complete_next_unit_source_brief|full_chapter_complete_completion_audit|maintenance_source_refresh_and_place_case_expansion)$/.test(status.nextGate)
