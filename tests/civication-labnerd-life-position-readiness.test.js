...
const streamPath='data/Civication/narratives/leisure/vitenskap_labnerd.json';
const stream=read(streamPath),row=audit.positions.find(x=>x.key==='vitenskap/labnerd');
...
assert.equal(stream.applies_when.any_tags[0],'vitenskap:labnerd');
...
console.log('Labnerd readiness and lifecycle complete ok');
