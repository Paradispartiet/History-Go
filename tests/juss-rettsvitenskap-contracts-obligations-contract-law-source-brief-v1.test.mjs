...
import { audit } from '../scripts/brief-juss-rettsvitenskap-contracts-obligations-contract-law-sources-v1.mjs';

test('Avtaler/obligasjoner er 13/8/32 source-first og ikke materialisert', () => {
  const report = audit();
