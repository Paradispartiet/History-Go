...
test('Språk & lingvistikk har felt 1-7 materialisert og felt 8 Sosiolingvistikk source-first', () => {
  const report = audit();
  ...
  assert.equal(report.nextDomain, 'sosiolingvistikk_variasjon_flerspraklighet_sprakmakt');
});
