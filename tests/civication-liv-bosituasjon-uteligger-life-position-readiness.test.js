...
assert.equal(audit.summary.classifications.ready, 22);
assert.equal(audit.summary.classifications.needs_authored_depth, 137);
...
assert.equal(audit.queue[0].key, 'by/urbanist');
...
console.log('civication Liv bosituasjon Uteligger readiness + Role World ok: 56/56 / 14 anchors / 107 total / 22 life-position worlds');
