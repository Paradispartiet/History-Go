...
assert.equal(audit.summary.classifications.ready, 23);
assert.equal(audit.summary.classifications.needs_authored_depth, 136);
...
console.log('civication Liv bosituasjon Uteligger readiness + Role World ok: 56/56 / 14 anchors / 108 total / 23 life-position worlds');
