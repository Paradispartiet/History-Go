...
assert.equal(audit.summary.classifications.ready, 19);
assert.equal(audit.summary.classifications.needs_authored_depth, 140);
...
console.log('civication Liv bosituasjon Uteligger readiness + Role World ok: 56/56 / 14 anchors / 104 total / 19 life-position worlds');
