...
assert.equal(audit.summary.positions_with_exact_governed_sources, 24);
assert.equal(audit.summary.positions_with_multi_scene_narrative_foundation, 24);
