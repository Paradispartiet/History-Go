...
assert.deepEqual(audit.summary.classifications, {
  ready: 147,
  needs_authored_depth: 12,
  not_a_standalone_world: 40
});
assert.equal(audit.summary.completed_life_position_role_worlds, 147);
assert.equal(audit.summary.pending_ready_positions, 0);
assert.equal(audit.summary.livelihood_backed_positions, 15);
assert.equal(audit.summary.positions_with_exact_governed_sources, 147);
assert.equal(audit.summary.positions_with_multi_scene_narrative_foundation, 147);
