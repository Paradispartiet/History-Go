...
assert.equal(audit.summary.positions_with_exact_governed_sources, 18);
assert.equal(audit.summary.positions_with_multi_scene_narrative_foundation, 18);
...
console.log('civication life-position Role World readiness v2 ok: 18 ready / 141 authored-depth / 40 not-standalone; 18 complete / no pending-ready');
