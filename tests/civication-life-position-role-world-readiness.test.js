...
assert.equal(audit.summary.positions_with_exact_governed_sources, 30);
assert.equal(audit.summary.positions_with_multi_scene_narrative_foundation, 30);
...
console.log('civication life-position Role World readiness v2 ok: 30 ready / 129 authored-depth / 40 not-standalone; 30 complete / no pending-ready');
