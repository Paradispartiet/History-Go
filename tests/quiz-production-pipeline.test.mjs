...
test("builds the full history production context through domain-based curriculum", async () => {
  ...
  assert.equal(context.considered_curriculum.counts.emner, 99);
  assert.equal(context.considered_curriculum.counts.topic_hooks, 93);
  assert.equal(context.considered_curriculum.counts.methods, 58);
