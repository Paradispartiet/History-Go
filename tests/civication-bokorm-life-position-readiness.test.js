...
const streamPath='data/Civication/narratives/leisure/litteratur_bokorm.json';
...
assert.equal(stream.applies_when.any_tags[0],'litteratur:bokorm');
...
console.log('Bokorm readiness and lifecycle complete ok');
