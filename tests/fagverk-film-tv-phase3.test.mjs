...
test('Film & TV er materialisert med canonical dekning og audiovisuelle source-first-porter', () => {
  ...
  const isProductionGate = /(?:source_brief_complete_full_chapter_production|full_chapter_complete_next_unit_source_brief|full_chapter_complete_completion_audit|maintenance_source_refresh_and_place_case_expansion)$/.test(report.subject.nextGate);
