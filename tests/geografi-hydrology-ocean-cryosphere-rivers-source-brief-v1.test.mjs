...
import { audit } from '../scripts/brief-geografi-hydrology-ocean-cryosphere-rivers-sources-v1.mjs';

test('Geografi felt 5 source-first låser hydrologi/hav/kryosfære før materialisering', () => {
  const report = audit();
