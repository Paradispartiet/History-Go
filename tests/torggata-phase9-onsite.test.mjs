...
test("Torggata har ingen canonical event og PlaceCard viser ingen globale Events/Møtes-handlinger", async () => {
  ...
  assert.doesNotMatch(runtime, /HGEvents|HG_SocialMeetUI|HG_SpotmeetingUI|CORE_SHORTCUTS/);
  ...
  const actions = Array.from(w.document.querySelectorAll("[data-hg-onsite-action]"));
