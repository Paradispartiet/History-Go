...
- Canonical heldekningsregel ligger i `docs/FAGVERK.md`: hvert fag skal dekke alle faglig relevante emner innenfor sin dokumenterte avgrensning. Antall fagområder, emner, kapitler, moduler, seksjoner, claims, kilder, eksempler og oppgaver rapporteres som inventar og integritet, aldri som en redaksjonell målkvote eller et selvstendig ferdigbevis.
- By-fagverkets materialiserte inventar ved siste helhetsaudit var 12 canonicale domener, 82 emner, 17 kapitler, 51 moduler, 459 claimsporede fagavsnitt, 306 verifiserte claims, 219 inspiserbare kilderegistreringer, 14 canonicale metoder og 20 unike stedscase. Tallene beskriver den auditerte pakken; de er ikke mal for andre fag eller framtidige kapitler.
- Kunst-fagverkets materialiserte inventar ved siste helhetsaudit var 6 canonicale domener, 21 emner, 6 kapitler, 18 moduler, 162 claimsporede fagavsnitt, 140 verifiserte claims, 100 inspiserbare kilderegistreringer og 21 canonicale metoder. Kapittelet `Tid og transformasjon` dekket sine to registrerte emner med 12 metoder, 18 primærkilder og 24 verifiserte claims; disse tallene er historisk inventar, ikke en kapittelkvote.
- Media-fagverkets materialiserte inventar ved siste helhetsaudit var 6 canonicale domener, 120 emner, 6 kapitler, 18 moduler, 162 claimsporede fagavsnitt, 160 verifiserte claims, 126 inspiserbare kilderegistreringer, 115 canonicale hovedmetoder og 15 unike stedscase. Siste kapittel dekket de 20 emnene som da var registrert for området; verken 20 emner, 27 claims eller andre tall skal gjentas som produksjonsmal. Nested Populærkultur hadde 56 registrerte emner.
