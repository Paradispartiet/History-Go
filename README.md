...
- Media-fagverket er redaksjonelt `chapters_in_progress`: `Presse, redaksjoner og avishus` og `Offentlighet, ytringsfrihet og medieetikk` dekker 21/21 domeneemner hver, mens `Kilder, kritikk og sannhet` og `Plattformer, algoritmer og distribusjon` dekker 20/20 hver. Hovedfaget står dermed på 4/6 domener og 82/120 emner gjennom 4 kapitler; det nye kapittelet har 3 moduler, 27 claimsporede fagavsnitt, 27 verifiserte claims, 20 inspiserbare kilderegistreringer, 4 canonicale stedscase og alle 20 canonicale metoder. Nested Populærkultur beholdes komplett med 56/56 emner, men Media som helhet er ikke ferdig.
