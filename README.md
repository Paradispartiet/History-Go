...
- Media-fagverket er redaksjonelt `chapters_in_progress`: første canonicale domene, `Presse, redaksjoner og avishus`, dekker eksakt 21/21 domeneemner gjennom 1 kapittel, 3 moduler, 27 claimsporede fagavsnitt, 25 verifiserte claims, 19 inspiserbare kilderegistreringer og 21 canonicale metoder. Hovedfaget står dermed på 1/6 domener og 21/120 emner; nested Populærkultur beholdes komplett med 56/56 emner, men Media som helhet er ikke ferdig.
