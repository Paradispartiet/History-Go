...
- Media-fagverket er redaksjonelt `chapters_in_progress`: `Presse, redaksjoner og avishus` og `Offentlighet, ytringsfrihet og medieetikk` dekker 21/21 domeneemner hver, mens `Kilder, kritikk og sannhet` dekker 20/20. Hovedfaget står dermed på 3/6 domener og 62/120 emner gjennom 3 kapitler; det nye kapittelet har 3 moduler, 27 claimsporede fagavsnitt, 27 verifiserte claims, 20 inspiserbare kilderegistreringer og alle 20 canonicale metoder. Nested Populærkultur beholdes komplett med 56/56 emner, men Media som helhet er ikke ferdig.
