...
- Kunst-fagverket står redaksjonelt korrekt som `chapters_in_progress`: fem av seks canonicale domener er materialisert gjennom 5 kapitler, 15 moduler og 135 claimsporede fagavsnitt. Nyeste kapittel er `Publikum og offentlighet` med eksakt 3/3 emnedekning, 13 metoder, 18 primærkilder og 24 verifiserte claims.
