...
- Media-fagverket er redaksjonelt `chapters_in_progress`: `Presse, redaksjoner og avishus` og `Offentlighet, ytringsfrihet og medieetikk` dekker begge eksakt 21/21 domeneemner. Hovedfaget står dermed på 2/6 domener og 42/120 emner gjennom 2 kapitler; det nye kapittelet har 3 moduler, 27 claimsporede fagavsnitt, 27 verifiserte claims, 20 inspiserbare kilderegistreringer og 20 unike canonicale metoder. Nested Populærkultur beholdes komplett med 56/56 emner, men Media som helhet er ikke ferdig.
