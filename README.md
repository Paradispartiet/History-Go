...
- Media-fagverket er redaksjonelt `complete` etter separat helhetsaudit: alle 6 canonicale domener og 120 emner er dekket gjennom 6 kapitler, 18 moduler, 162 claimsporede fagavsnitt, 160 verifiserte claims, 126 inspiserbare kilderegistreringer, alle 115 canonicale hovedmetoder og 15 unike stedscase. Siste kapittel er `Medieøkonomi, eierskap og arbeid` med eksakt 20/20 emnedekning, 19 metoder, 24 kilder, 27 claims, 4 stedscase og 30 eksplisitte fagskiller. Nested Populærkultur beholdes komplett med 56/56 emner.
