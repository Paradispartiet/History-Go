...
- Added declaration-only Civication globals in `schemas/civication-globals.d.ts` for existing runtime symbols (`CivicationPsyche`, `getQuizCountLastWeek`) to reduce missing-global friction.
