...
- Other pages: `knowledge.html`, `emner.html`, `notater.html`, `sprakatlas.html` (standalone Språkatlas Norge; never embedded in PlaceCard), and the compatibility redirect `merker/merker.html`.
