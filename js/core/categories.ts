...
const CATEGORY_LIST: CategoryDefinition[] = [
  { id: "historie", name: "Historie", icon: "🏛️", color: "#344B80", scope: "runtime_domain" },
  { id: "religion", name: "Religion", icon: "🛐", color: "#d7b46a", scope: "runtime_domain" },
  { id: "vitenskap", name: "Vitenskap & filosofi", icon: "🧪", color: "#9b59b6", scope: "runtime_domain" },
  { id: "kunst", name: "Kunst & kultur", icon: "🎨", color: "#ffb703", scope: "runtime_domain" },
  { id: "musikk", name: "Musikk & scenekunst", icon: "🎭", color: "#ff66cc", scope: "runtime_domain" },
  { id: "natur", name: "Natur & miljø", icon: "🌿", color: "#4caf50", scope: "runtime_domain" },
  { id: "sport", name: "Sport & lek", icon: "⚽", color: "#2a9d8f", scope: "runtime_domain" },
  { id: "by", name: "By & arkitektur", icon: "🏙️", color: "#e63946", scope: "runtime_domain" },
  { id: "politikk", name: "Politikk & samfunn", icon: "🏛️", color: "#c77dff", scope: "runtime_domain" },
  { id: "subkultur", name: "Subkultur", icon: "🧷", color: "#ff66cc", scope: "runtime_domain" },
  { id: "litteratur", name: "Litteratur", icon: "📚", color: "#f6c800", scope: "runtime_domain" },
  { id: "naeringsliv", name: "Næringsliv", icon: "🏭", color: "#ff8800", scope: "runtime_domain" },
