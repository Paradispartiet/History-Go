...
| CareerKnowledgeBridge | `CivicationCareerKnowledgeBridge` | Kobler `role_scope` og spikrede, versjonerte mailkontrakter til levende Fagverk-referanser. Hydrerer stillingsfordypning og vurderer lagret Knowledge som rådgivende beslutningsstøtte; gir aldri jobb, myndighet eller forfremmelse. |
...
data/badges.json
  ...
  → data/Civication/careerKnowledgeBridge.json                   (stabile Fagverk-ID-er + oppdateringskontrakt)
