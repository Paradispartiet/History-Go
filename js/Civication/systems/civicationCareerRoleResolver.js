(function initCareerRoleResolver(globalScope) {
  ...
  // Næringsliv keeps its mature playable runtime scopes. The newer shared
  // work-world scopes live in the Badge career contract/FWG layer; they do not
  // replace established mail/Life Story role scopes until those packages are
  // migrated explicitly.
  ...
  const MEDIA_ROLE_SCOPE_BY_TITLE = {
    journalist: 'media_redaksjon',
    reporter: 'media_redaksjon',
    redaksjonsmedarbeider: 'media_redaksjon',
    redaktor: 'media_redaksjonell_ledelse',
    sjefredaktor: 'media_redaksjonell_ledelse',
    nyhetsleder: 'media_redaksjonell_ledelse'
  };

  const RELIGION_ROLE_SCOPE_BY_TITLE = {
    religionsformidler: 'religion_formidling_og_kulturarv',
    kurator: 'religion_formidling_og_kulturarv',
    fagkonsulent: 'religion_utredning_og_radgivning',
    seniorradgiver: 'religion_utredning_og_radgivning',
    religionshistoriker: 'religion_forskning',
    religionsviter: 'religion_forskning',
    forsker: 'religion_forskning',
    seniorforsker: 'religion_forskning',
    fagansvarlig: 'religion_fagledelse',
    seksjonsleder: 'religion_fagledelse',
    avdelingsleder: 'religion_fagledelse',
    avdelingsdirektor: 'religion_fagledelse',
    direktor: 'religion_fagledelse'
  };

  const FILOSOFI_ROLE_SCOPE_BY_TITLE = {
    idehistoriker: 'filosofi_forskning_og_formidling',
    filosof: 'filosofi_forskning_og_formidling',
    foreleser: 'filosofi_undervisning_og_akademia',
    professor: 'filosofi_undervisning_og_akademia'
  };
  ...
  const NATUR_ROLE_SCOPE_BY_TITLE = {
    ...
    naturforvalter: 'natur_forvaltning_og_radgivning',
    radgiver_miljo_natur: 'natur_forvaltning_og_radgivning',
    seniorradgiver_miljo_natur: 'natur_forvaltning_og_radgivning',
    biolog: 'natur_biologi_og_forskning',
    okolog: 'natur_biologi_og_forskning',
    forsker_miljo_natur: 'natur_biologi_og_forskning',
    seniorforsker_miljo_natur: 'natur_biologi_og_forskning',
    naturvernleder: 'natur_miljoledelse',
    miljosjef: 'natur_miljoledelse',
    miljodirektor: 'natur_miljoledelse',
    statsrad_klima_og_miljo: 'natur_politisk_myndighet'
  };

  const POLITIKK_ROLE_SCOPE_BY_TITLE = {
    organisasjonssekretaer: 'politikk_organisasjonsarbeid',
    politisk_radgiver: 'politikk_politisk_radgivning',
    ordforer: 'politikk_kommunal_ledelse',
    stortingsrepresentant: 'politikk_parlamentarisk_arbeid',
    statssekretaer: 'politikk_regjeringsledelse',
    statsrad_minister: 'politikk_regjeringsledelse',
  ...
  function resolveCareerRoleScope(activePosition) {
    ...
    if (careerId === 'naeringsliv') {
      if (NAERINGSLIV_NON_JOB_TITLES.has(titleKey) || NAERINGSLIV_NON_JOB_TITLES.has(roleKey)) {
        return 'unknown';
      }
    ...
    const genericScopes = [
      'religion_formidling_og_kulturarv',
      'religion_utredning_og_radgivning',
      'religion_forskning',
      'religion_fagledelse',
      'filosofi_forskning_og_formidling',
      ...
      'natur_miljoledelse',
      'natur_politisk_myndighet',
      'politikk_organisasjonsarbeid',
      'politikk_politisk_radgivning',
      'politikk_kommunal_ledelse',
      'politikk_parlamentarisk_arbeid',
      'politikk_regjeringsledelse',
      ...
      'psykologi_arbeids_og_karriereveiledning',
