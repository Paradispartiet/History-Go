...
(function () {
  const DISTRICTS = [
    {
      ...
      center: [0.50, 0.62],
      shape: [[0.43,0.56],[0.57,0.56],[0.60,0.63],[0.57,0.70],[0.49,0.72],[0.42,0.67],[0.41,0.60]],
  ...
  const OSLO_SKELETON = {
    anchors: {
      sentrum:[0.50,0.62], radhus_fjord:[0.46,0.69], oslo_s:[0.55,0.65], akerselva_mouth:[0.50,0.67],
      grunerlokka:[0.54,0.49], sagene:[0.53,0.38], frogner:[0.36,0.60], ullern:[0.24,0.62],
      gamle_oslo:[0.61,0.66], alna:[0.72,0.48], nordstrand:[0.69,0.80], stovner:[0.80,0.26]
    }
  };

  const OSLO_LANDSCAPE = {
    markaNorth:[[0.02,0.00],[0.98,0.00],[0.98,0.30],[0.84,0.26],[0.70,0.29],[0.56,0.25],[0.44,0.28],[0.30,0.24],[0.16,0.27],[0.02,0.22]],
    cityBasin:[[0.06,0.23],[0.16,0.19],[0.30,0.22],[0.44,0.20],[0.58,0.23],[0.70,0.20],[0.84,0.24],[0.93,0.34],[0.92,0.76],[0.80,0.84],[0.62,0.86],[0.50,0.80],[0.38,0.84],[0.20,0.82],[0.07,0.72]],
    ekebergRidge:[[0.61,0.66],[0.80,0.68],[0.87,0.84],[0.76,0.94],[0.61,0.89],[0.58,0.76]],
    fjord:[[0.00,0.76],[1.00,0.80],[1.00,1.00],[0.00,1.00]],
    innerFjordArm:[[0.35,0.76],[0.47,0.69],[0.55,0.70],[0.68,0.75],[0.62,0.84],[0.46,0.86],[0.33,0.82]],
    akerselva:[[0.52,0.24],[0.53,0.30],[0.53,0.36],[0.54,0.44],[0.53,0.51],[0.52,0.57],[0.51,0.62],[0.50,0.68]]
  };
