...
(function () {
  ...
  function typeLabel(type) {
    const labels = {
      ...
      season_zone: "Sesongsone",
      seasonal_activity: "Sesongaktivitet",
      weather_activity: "Væropplevelse",
      light_observation: "Lysobservasjon",
      winter_activity: "Vinteraktivitet",
      spring_observation: "Vårtegn",
      summer_activity: "Sommeraktivitet",
      autumn_observation: "Høstobservasjon",
      rain_observation: "Regnobservasjon",
      snow_observation: "Snøobservasjon",
      wind_observation: "Vindobservasjon",
      water_observation: "Vannobservasjon",
